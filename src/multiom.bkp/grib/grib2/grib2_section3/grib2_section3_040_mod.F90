...
PP_THREAD_SAFE FUNCTION GRIB2_SECTION3_040_INIT( THIS, PAR, &
...
PP_THREAD_SAFE FUNCTION GRIB2_SECTION3_040_ALLOCATE( THIS, PAR, &
...
PP_THREAD_SAFE FUNCTION GRIB2_SECTION3_040_PRESET( THIS, PAR, &
&   MSG, METADATA, HOOKS ) RESULT(RET)
...
PP_THREAD_SAFE FUNCTION GRIB2_SECTION3_040_RUNTIME( THIS, PAR, &
...
PP_THREAD_SAFE FUNCTION GRIB2_SECTION3_040_TO_BE_ENCODED( THIS, PAR, &
...
PP_THREAD_SAFE FUNCTION GRIB2_SECTION3_040_FREE( THIS, HOOKS ) RESULT(RET)
...
PP_THREAD_SAFE FUNCTION GRIB2_SECTION3_040_PRINT( THIS, UNIT, OFFSET, HOOKS ) RESULT(RET)
