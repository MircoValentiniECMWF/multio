...
PP_THREAD_SAFE FUNCTION GRIB2_SECTION3_101_INIT( THIS, PAR, &
...
PP_THREAD_SAFE FUNCTION GRIB2_SECTION3_101_ALLOCATE( THIS, PAR, &
...
PP_THREAD_SAFE FUNCTION GRIB2_SECTION3_101_PRESET( THIS, PAR, &
&   MSG, METADATA, HOOKS ) RESULT(RET)
...
PP_THREAD_SAFE FUNCTION GRIB2_SECTION3_101_RUNTIME( THIS, PAR, &
...
PP_THREAD_SAFE FUNCTION GRIB2_SECTION3_101_TO_BE_ENCODED( THIS, PAR, &
...
PP_THREAD_SAFE FUNCTION GRIB2_SECTION3_101_FREE( THIS, HOOKS ) RESULT(RET)
...
PP_THREAD_SAFE FUNCTION GRIB2_SECTION3_101_PRINT( THIS, UNIT, OFFSET, HOOKS ) RESULT(RET)
