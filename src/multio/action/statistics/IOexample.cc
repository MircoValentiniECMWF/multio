...
void StatisticsIO::startOperation(const std::string& partialPath, const std::string& operationKind,
...
void StatisticsIO::writePeriod(const eckit::DateTime& startTime, const eckit::DateTime& endTime,
