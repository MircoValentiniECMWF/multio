...
void Statistics::PrintProfilingInfo() {
    ...
    std::cout << " + Operation Tot. UpdateWindow Time              :: " << std::setw(16) << static_cast<double>(profileTime_[1]/1000)/1000000                       << " [s],  Operation Tot. Number Of Calls to UpdateWindow :: " << std::setw(16) << profileNCalls_[1]<< std::endl;
    std::cout << " + Operation Tot. UpdateData Time                :: " << std::setw(16) << static_cast<double>(profileTime_[2]/1000)/1000000                       << " [s],  Operation Tot. Number Of Calls to UpdateData   :: " << std::setw(16) << profileNCalls_[2]<< std::endl;
    ...
    std::cout << " + Operation Mean UpdateWindow Time              :: " << std::setw(16) << static_cast<double>(profileTime_[1]/1000)/(nExecuteImplCalls_*1000000)  << " [s]" << std::endl;
    std::cout << " + Operation Mean UpdateData Time                :: " << std::setw(16) << static_cast<double>(profileTime_[2]/1000)/(nExecuteImplCalls_*1000000)  << " [s]" << std::endl;
