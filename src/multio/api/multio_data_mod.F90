...
contains 
    ...
    !!
    function multio_data_new(data, byte_size) result(err)
        use, intrinsic :: iso_c_binding, only: c_int
    implicit none
        ! Dummy arguments
        ...
        interface
            function c_multio_data_new(data) result(err) &
    ...
    implicit none
        ...
        ! Call the c API
        c_err = c_multio_data_zero(data%impl)
        ! Output cast and cleanup
        err = int(c_err,kind(err))
        ! Exit point
        return
    ...
    implicit none
        ...
        c_err = c_multio_data_resize(data%impl, c_size)
        ! Output cast and cleanup
        err = int(c_err,kind(err))
        ! Exit point
        return
    ...
    implicit none
        ...
        ! Call the c API
        c_err = c_multio_data_size(data%impl, c_loc(c_size))
        ! Output cast and cleanup
    ...
    implicit none
        ...
        c_err = c_multio_data_set_float_scalar(data%impl, c_loc(value), pos)
        ! Output cast and cleanup
        err = int(c_err,kind(err))
        ! Exit point
        return
   ...
   !>
    ...
    implicit none
        ...
        c_err = c_multio_data_set_float_chunk(data%impl, c_loc(value), c_pos, c_size)
        ! Output cast and cleanup
        err = int(c_err,kind(err))
        ! Exit point
        return
   ...
   !>
    ...
    implicit none
        ...
        ! Call the c API
        c_pos = int(pos,kind(c_pos))
        c_err = c_multio_data_set_double_scalar(data%impl, c_loc(value), c_pos)
        ! Output cast and cleanup
        err = int(c_err,kind(err))
        ! Exit point
        return
   ...
   !>
    ...
    implicit none
        ...
        c_pos  = int(pos,kind(c_pos))        
        c_size = int(size,kind(c_size))        
        c_err  = c_multio_data_set_double_chunk(data%impl, c_loc(value), c_pos, c_size)
        ! Output cast and cleanup
        err = int(c_err,kind(err))
        ! Exit point
        return
