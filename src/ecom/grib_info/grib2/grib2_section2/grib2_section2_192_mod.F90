...
CONTAINS
  ...
  !> object for use.
  !>
  PUBLIC, PASS, NON_OVERRIDABLE :: INIT => GRIB2_SECTION2_192_INIT
  ...
  !>
  PUBLIC, PASS, NON_OVERRIDABLE :: ALLOCATE => GRIB2_SECTION2_192_ALLOCATE
  ...
  !>
  PUBLIC, PASS, NON_OVERRIDABLE :: PRESET => GRIB2_SECTION2_192_PRESET
  ...
  !>
  PUBLIC, PASS, NON_OVERRIDABLE :: RUNTIME => GRIB2_SECTION2_192_RUNTIME
  ...
  !>
  PUBLIC, PASS, NON_OVERRIDABLE :: TO_BE_ENCODED => GRIB2_SECTION2_192_TO_BE_ENCODED
  ...
  !>
  PUBLIC, PASS, NON_OVERRIDABLE :: FREE => GRIB2_SECTION2_192_FREE
...
__THREAD_SAFE__ FUNCTION GRIB2_SECTION2_192_INIT( THIS, PARAMS, &
...
__THREAD_SAFE__ FUNCTION GRIB2_SECTION2_192_ALLOCATE( THIS, PARAMS, &
...
IMPLICIT NONE
  ...
  !> Dummy arguments
  CLASS(GRIB2_SECTION2_192_T),     INTENT(IN)    :: THIS
  TYPE(MODEL_PAR_T),               INTENT(IN)    :: PARAMS
...
__THREAD_SAFE__ FUNCTION GRIB2_SECTION2_192_PRESET( THIS, PARAMS, &
&   MSG, METADATA, VERBOSE ) RESULT(RET)
...
__THREAD_SAFE__ FUNCTION GRIB2_SECTION2_192_RUNTIME( THIS, PARAMS, &
...
__THREAD_SAFE__ FUNCTION GRIB2_SECTION2_192_TO_BE_ENCODED( THIS, PARAMS, &
...
__THREAD_SAFE__ FUNCTION GRIB2_SECTION2_192_FREE( THIS, VERBOSE ) RESULT(RET)
