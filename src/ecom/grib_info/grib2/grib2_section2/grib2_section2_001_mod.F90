!>
!> @file grib2_section2_000_mod.F90
!>
!> @brief Module for managing GRIB2 Section 2 operations.
!>
!> The `GRIB2_SECTION2_000_MOD` module contains procedures to initialize, allocate,
...
!>   - @see GRIB2_SECTION2_000_INIT
!>   - @see GRIB2_SECTION2_000_ALLOCATE
!>   - @see GRIB2_SECTION2_000_PRESET
!>   - @see GRIB2_SECTION2_000_RUNTIME
!>   - @see GRIB2_SECTION2_000_TO_BE_ENCODED
!>   - @see GRIB2_SECTION2_000_FREE
!>
...
#define PP_FILE_NAME 'grib2_section2_000_mod.F90'
#define PP_SECTION_TYPE 'MODULE'
#define PP_SECTION_NAME 'GRIB2_SECTION2_000_MOD'
MODULE GRIB2_SECTION2_000_MOD
...
!>
!> The `GRIB2_SECTION2_000_T` type extends the base class `GRIB_SECTION_BASE_A` and
...
!> environments.
!>
TYPE, EXTENDS(GRIB_SECTION_BASE_A) :: GRIB2_SECTION2_000_T
...
CONTAINS
  ...
  !> object for use.
  !>
  PUBLIC, PASS, NON_OVERRIDABLE :: INIT => GRIB2_SECTION2_000_INIT
  ...
  !>
  PUBLIC, PASS, NON_OVERRIDABLE :: ALLOCATE => GRIB2_SECTION2_000_ALLOCATE
  ...
  !>
  PUBLIC, PASS, NON_OVERRIDABLE :: PRESET => GRIB2_SECTION2_000_PRESET
  ...
  !>
  PUBLIC, PASS, NON_OVERRIDABLE :: RUNTIME => GRIB2_SECTION2_000_RUNTIME
  ...
  !>
  PUBLIC, PASS, NON_OVERRIDABLE :: TO_BE_ENCODED => GRIB2_SECTION2_000_TO_BE_ENCODED
  ...
  !>
  PUBLIC, PASS, NON_OVERRIDABLE :: FREE => GRIB2_SECTION2_000_FREE
...
#define PP_PROCEDURE_NAME 'GRIB2_SECTION2_000_INIT'
__THREAD_SAFE__ FUNCTION GRIB2_SECTION2_000_INIT( THIS, PARAMS, &
...
IMPLICIT NONE
  ...
  !> Dummy arguments
  CLASS(GRIB2_SECTION2_000_T), INTENT(INOUT) :: THIS
...
END FUNCTION GRIB2_SECTION2_000_INIT
...
!>
#define PP_PROCEDURE_TYPE 'FUNCTION'
#define PP_PROCEDURE_NAME 'GRIB2_SECTION2_000_ALLOCATE'
__THREAD_SAFE__ FUNCTION GRIB2_SECTION2_000_ALLOCATE( THIS, PARAMS, &
...
IMPLICIT NONE
  ...
  !> Dummy arguments
  CLASS(GRIB2_SECTION2_000_T),     INTENT(IN)    :: THIS
  TYPE(MODEL_PAR_T),               INTENT(IN)    :: PARAMS
...
END FUNCTION GRIB2_SECTION2_000_ALLOCATE
#undef PP_PROCEDURE_NAME
#undef PP_PROCEDURE_TYPE
...
!>
#define PP_PROCEDURE_TYPE 'FUNCTION'
#define PP_PROCEDURE_NAME 'GRIB2_SECTION2_000_PRESET'
__THREAD_SAFE__ FUNCTION GRIB2_SECTION2_000_PRESET( THIS, PARAMS, &
&   MSG, METADATA, VERBOSE ) RESULT(RET)
...
END FUNCTION GRIB2_SECTION2_000_PRESET
#undef PP_PROCEDURE_NAME
#undef PP_PROCEDURE_TYPE
...
!>
#define PP_PROCEDURE_TYPE 'FUNCTION'
#define PP_PROCEDURE_NAME 'GRIB2_SECTION2_000_RUNTIME'
__THREAD_SAFE__ FUNCTION GRIB2_SECTION2_000_RUNTIME( THIS, PARAMS, &
...
END FUNCTION GRIB2_SECTION2_000_RUNTIME
#undef PP_PROCEDURE_NAME
#undef PP_PROCEDURE_TYPE
...
!>
#define PP_PROCEDURE_TYPE 'FUNCTION'
#define PP_PROCEDURE_NAME 'GRIB2_SECTION2_000_TO_BE_ENCODED'
__THREAD_SAFE__ FUNCTION GRIB2_SECTION2_000_TO_BE_ENCODED( THIS, PARAMS, &
...
END FUNCTION GRIB2_SECTION2_000_TO_BE_ENCODED
#undef PP_PROCEDURE_NAME
#undef PP_PROCEDURE_TYPE
...
!>
#define PP_PROCEDURE_TYPE 'FUNCTION'
#define PP_PROCEDURE_NAME 'GRIB2_SECTION2_000_FREE'
__THREAD_SAFE__ FUNCTION GRIB2_SECTION2_000_FREE( THIS, VERBOSE ) RESULT(RET)
...
END FUNCTION GRIB2_SECTION2_000_FREE
#undef PP_PROCEDURE_NAME
#undef PP_PROCEDURE_TYPE

END MODULE GRIB2_SECTION2_000_MOD
