...
CONTAINS
  ...
  PUBLIC, PASS, PUBLIC, NON_OVERRIDABLE :: INIT                  => GRIB2_SECTION5_042_INIT
  PUBLIC, PASS, PUBLIC, NON_OVERRIDABLE :: ALLOCATE              => GRIB2_SECTION5_042_ALLOCATE
  PUBLIC, PASS, PUBLIC, NON_OVERRIDABLE :: PRESET                => GRIB2_SECTION5_042_PRESET
  PUBLIC, PASS, PUBLIC, NON_OVERRIDABLE :: NUMBER_OF_RUNTIME_OPS => GRIB2_SECTION5_042_GET_RUNTIME_OPS
  PUBLIC, PASS, PUBLIC, NON_OVERRIDABLE :: GET_RUNTIME_OPS       => GRIB2_SECTION5_042_NUMBER_OF_RUNTIME_OPS
  PUBLIC, PASS, PUBLIC, NON_OVERRIDABLE :: FREE                  => GRIB2_SECTION5_042_FREE
...
__THREAD_SAFE__ FUNCTION GRIB2_SECTION5_042_INIT( THIS, PARAMS, CFG, VERBOSE ) RESULT(RET)
...
__THREAD_SAFE__ FUNCTION GRIB2_SECTION5_042_ALLOCATE( THIS, PARAMS, MSG, METADATA, VERBOSE ) RESULT(RET)
...
__THREAD_SAFE__ FUNCTION GRIB2_SECTION5_042_PRESET( THIS, PARAMS, MSG, METADATA, VERBOSE ) RESULT(RET)
...
#define PP_PROCEDURE_TYPE 'FUNCTION'
#define PP_PROCEDURE_NAME 'GRIB2_SECTION5_042_NUMBER_OF_RUNTIME_OPS'
__THREAD_SAFE__ FUNCTION GRIB2_SECTION5_042_NUMBER_OF_RUNTIME_OPS( THIS, PARAMS, MSG, NUM_RUNTIME_OPS, VERBOSE ) RESULT(RET)
...
END FUNCTION GRIB2_SECTION5_042_NUMBER_OF_RUNTIME_OPS
#undef PP_PROCEDURE_NAME
#undef PP_PROCEDURE_TYPE


#define PP_PROCEDURE_TYPE 'FUNCTION'
#define PP_PROCEDURE_NAME 'GRIB2_SECTION5_042_GET_RUNTIME_OPS'
__THREAD_SAFE__ FUNCTION GRIB2_SECTION5_042_GET_RUNTIME_OPS( THIS, PARAMS, RUNTIME_OPS, VERBOSE ) RESULT(RET)
...
END FUNCTION GRIB2_SECTION5_042_GET_RUNTIME_OPS
#undef PP_PROCEDURE_NAME
#undef PP_PROCEDURE_TYPE
