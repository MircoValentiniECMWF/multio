...
CONTAINS
  ...
  !> object for use.
  !>
  PUBLIC, PASS, NON_OVERRIDABLE :: INIT => GRIB2_SECTION1_000_INIT
  ...
  !>
  PUBLIC, PASS, NON_OVERRIDABLE :: ALLOCATE => GRIB2_SECTION1_000_ALLOCATE
  ...
  !>
  PUBLIC, PASS, NON_OVERRIDABLE :: PRESET => GRIB2_SECTION1_000_PRESET
  ...
  !>
  PUBLIC, PASS, NON_OVERRIDABLE :: RUNTIME => GRIB2_SECTION1_000_RUNTIME
  ...
  !>
  PUBLIC, PASS, NON_OVERRIDABLE :: TO_BE_ENCODED => GRIB2_SECTION1_000_TO_BE_ENCODED
  ...
  !>
  PUBLIC, PASS, NON_OVERRIDABLE :: FREE => GRIB2_SECTION1_000_FREE
...
!>
!> This function initializes a GRIB2 Section 1 object (`THIS`) using the provided model parameters (`PARAMS`)
...
!> @section interface
!>
!> @param [inout] THIS    GRIB2 Section 1 object to be initialized.
...
__THREAD_SAFE__ FUNCTION GRIB2_SECTION1_000_INIT( THIS, PARAMS, &
...
!> @section interface
!>
!> @param [in]    THIS      GRIB2 Section 1 object for which resources are allocated.
...
__THREAD_SAFE__ FUNCTION GRIB2_SECTION1_000_ALLOCATE( THIS, PARAMS, &
...
IMPLICIT NONE
  ...
  !> Dummy arguments
  CLASS(GRIB2_SECTION1_000_T),     INTENT(IN)    :: THIS
  TYPE(MODEL_PAR_T),               INTENT(IN)    :: PARAMS
...
!> @section interface
!>
!> @param [in]    THIS      GRIB2 Section 1 object to be preset.
...
__THREAD_SAFE__ FUNCTION GRIB2_SECTION1_000_PRESET( THIS, PARAMS, &
&   MSG, METADATA, VERBOSE ) RESULT(RET)
...
!> @section interface
!>
!> @param [in]    THIS          GRIB2 Section 1 object for runtime execution.
...
__THREAD_SAFE__ FUNCTION GRIB2_SECTION1_000_RUNTIME( THIS, PARAMS, &
...
!> @section interface
!>
!> @param [inout] THIS          GRIB2 Section 1 object to be checked for encoding readiness.
...
__THREAD_SAFE__ FUNCTION GRIB2_SECTION1_000_TO_BE_ENCODED( THIS, PARAMS, &
...
!> @section interface
!>
!> @param [inout] THIS    GRIB2 Section 1 object to be deallocated and freed.
...
__THREAD_SAFE__ FUNCTION GRIB2_SECTION1_000_FREE( THIS, VERBOSE ) RESULT(RET)
