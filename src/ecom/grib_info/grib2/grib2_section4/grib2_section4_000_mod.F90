...
TYPE, EXTENDS(GRIB_SECTION_BASE_A) :: GRIB2_SECTION4_000_T
  ...
  !> Object use to configure the time information
  ! CLASS(TIME_CONFIGURATOR_T),  POINTER :: TIME_CONFIGURATOR_ => NULL()

  !> Object use to configure the level information
  ! CLASS(LEVEL_CONFIGURATOR_T), POINTER :: LEVEL_CONFIGURATOR_ => NULL()
...
CONTAINS
  ...
  !> object for use.
  !>
  PUBLIC, PASS, NON_OVERRIDABLE :: INIT => GRIB2_SECTION4_000_INIT
  ...
  !>
  PUBLIC, PASS, NON_OVERRIDABLE :: ALLOCATE => GRIB2_SECTION4_000_ALLOCATE
  ...
  !>
  PUBLIC, PASS, NON_OVERRIDABLE :: PRESET => GRIB2_SECTION4_000_PRESET
  ...
  !>
  PUBLIC, PASS, NON_OVERRIDABLE :: RUNTIME => GRIB2_SECTION4_000_RUNTIME
  ...
  !>
  PUBLIC, PASS, NON_OVERRIDABLE :: TO_BE_ENCODED => GRIB2_SECTION4_000_TO_BE_ENCODED
  ...
  !>
  PUBLIC, PASS, NON_OVERRIDABLE :: FREE => GRIB2_SECTION4_000_FREE
...
__THREAD_SAFE__ FUNCTION GRIB2_SECTION4_000_INIT( THIS, PARAMS, &
...
__THREAD_SAFE__ FUNCTION GRIB2_SECTION4_000_ALLOCATE( THIS, PARAMS, &
...
__THREAD_SAFE__ FUNCTION GRIB2_SECTION4_000_PRESET( THIS, PARAMS, &
&   MSG, METADATA, VERBOSE ) RESULT(RET)
...
__THREAD_SAFE__ FUNCTION GRIB2_SECTION4_000_RUNTIME( THIS, PARAMS, &
...
__THREAD_SAFE__ FUNCTION GRIB2_SECTION4_000_TO_BE_ENCODED( THIS, PARAMS, &
