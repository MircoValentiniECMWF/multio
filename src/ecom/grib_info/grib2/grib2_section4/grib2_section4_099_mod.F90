...
CONTAINS
  ...
  !> object for use.
  !>
  PUBLIC, PASS, NON_OVERRIDABLE :: INIT => GRIB2_SECTION4_099_INIT
  ...
  !>
  PUBLIC, PASS, NON_OVERRIDABLE :: PRESET => GRIB2_SECTION4_099_PRESET
  ...
  !>
  PUBLIC, PASS, NON_OVERRIDABLE :: RUNTIME => GRIB2_SECTION4_099_RUNTIME
  ...
  !>
  PUBLIC, PASS, NON_OVERRIDABLE :: TO_BE_ENCODED => GRIB2_SECTION4_099_TO_BE_ENCODED
  ...
  !>
  PUBLIC, PASS, NON_OVERRIDABLE :: FREE => GRIB2_SECTION4_099_FREE
...
__THREAD_SAFE__ FUNCTION GRIB2_SECTION4_099_INIT( THIS, PARAMS, &
...
__THREAD_SAFE__ FUNCTION GRIB2_SECTION4_099_ALLOCATE( THIS, PARAMS, &
...
__THREAD_SAFE__ FUNCTION GRIB2_SECTION4_099_PRESET( THIS, PARAMS, &
&   MSG, METADATA, VERBOSE ) RESULT(RET)
...
__THREAD_SAFE__ FUNCTION GRIB2_SECTION4_099_RUNTIME( THIS, PARAMS, &
...
__THREAD_SAFE__ FUNCTION GRIB2_SECTION4_099_TO_BE_ENCODED( THIS, PARAMS, &
