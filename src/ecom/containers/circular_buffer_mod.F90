...
__THREAD_SAFE__ SUBROUTINE CB_INIT(THIS, CAPACITY)
...
__THREAD_SAFE__ SUBROUTINE CB_FREE( THIS )
...
__THREAD_SAFE__ SUBROUTINE CB_ENQUEUE(THIS, VALUE)
...
__THREAD_SAFE__ FUNCTION CB_DEQUEUE(THIS, VALUE) RESULT(EX)
...
__THREAD_SAFE__ FUNCTION CB_GET(THIS, I, VALUE) RESULT(EX)
...
__THREAD_SAFE__ FUNCTION CB_GET_ALL(THIS, SZ, VALUES) RESULT(EX)
...
__THREAD_SAFE__ FUNCTION CB_SIZE(THIS) RESULT(SIZE)
...
__THREAD_SAFE__ FUNCTION CB_IS_EMPTY(THIS) RESULT(IS_EMPTY)
