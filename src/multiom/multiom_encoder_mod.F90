...
& ENCODER_OPTIONS, FILTER_OPTIONS, HOOKS ) RESULT(RET)
...
&   MSG, PAR, THIS%MAPPING_RULES, THIS%ENCODER_OPTIONS, THIS%FILTER_OPTIONS, MAPPER, HOOKS )
...
&     MSG, PAR, THIS%METADATA, THIS%ENCODER_RULES, THIS%ENCODER_OPTIONS, ENCODERS, HOOKS )
