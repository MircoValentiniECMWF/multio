...
CONTAINS
  ...
  !> GRIB2 encoder.
  !>
  PROCEDURE, PUBLIC, PASS, NON_OVERRIDABLE :: INIT => GRIB2_SECTION4_001_INIT_CFG
  ...
  !> the GRIB2 encoder.
  !>
  PROCEDURE, PUBLIC, PASS, NON_OVERRIDABLE :: INIT => GRIB2_SECTION4_001_INIT_LAZY
...
PP_THREAD_SAFE FUNCTION GRIB2_SECTION4_001_PRESET( HIS, &
&  MSG, PAR, OPT,  METADATA, HOOKS ) RESULT(RET)
...
PP_THREAD_SAFE FUNCTION GRIB2_SECTION4_001_TO_BE_ENCODED( HIS, &
