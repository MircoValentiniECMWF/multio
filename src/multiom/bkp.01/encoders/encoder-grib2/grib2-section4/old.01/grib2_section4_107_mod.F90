!>
!> @file grib2_section4_107_mod.F90
!>
!> @brief Module for managing GRIB2 Section 4 operations.
!>
!> The `GRIB2_SECTION4_107_MOD` module contains procedures to initialize, allocate,
...
!>   - @see GRIB2_SECTION4_107_INIT
!>   - @see GRIB2_SECTION4_107_ALLOCATE
!>   - @see GRIB2_SECTION4_107_PRESET
!>   - @see GRIB2_SECTION4_107_RUNTIME
!>   - @see GRIB2_SECTION4_107_TO_BE_ENCODED
!>   - @see GRIB2_SECTION4_107_FREE
!>
...
#define PP_FILE_NAME 'grib2_section4_107_mod.F90'
#define PP_SECTION_TYPE 'MODULE'
#define PP_SECTION_NAME 'GRIB2_SECTION4_107_MOD'
MODULE GRIB2_SECTION4_107_MOD
...
!>
!> The `GRIB2_SECTION4_107_T` type extends the base class `GRIB_SECTION_BASE_A` and
...
!>
!>
TYPE, EXTENDS(GRIB_SECTION_BASE_A) :: GRIB2_SECTION4_107_T

  !> DEfault visibiltiy of the type
  PRIVATE
...
CONTAINS
  ...
  !> GRIB2 encoder.
  !>
  PROCEDURE, PUBLIC, PASS, NON_OVERRIDABLE :: INIT => GRIB2_SECTION4_107_INIT_CFG
  ...
  !> the GRIB2 encoder.
  !>
  PROCEDURE, PUBLIC, PASS, NON_OVERRIDABLE :: INIT => GRIB2_SECTION4_107_INIT_LAZY
  ...
  !> the object based on provided parameters. (The eccodes keywords that require
  !> a change in the memory footprint are set in this procedure)
  !>
  PROCEDURE, PUBLIC, PASS, NON_OVERRIDABLE :: ALLOCATE => GRIB2_SECTION4_107_ALLOCATE
  ...
  !> before runtime execution. All the prarmeters that are not changing in time
  !> are set in this procedure
  !>
  PROCEDURE, PUBLIC, PASS, NON_OVERRIDABLE :: PRESET => GRIB2_SECTION4_107_PRESET
  ...
  !>
  PROCEDURE, PUBLIC, PASS, NON_OVERRIDABLE :: RUNTIME => GRIB2_SECTION4_107_RUNTIME
  ...
  !>
  PROCEDURE, PUBLIC, PASS, NON_OVERRIDABLE :: TO_BE_ENCODED => GRIB2_SECTION4_107_TO_BE_ENCODED
  ...
  !>
  PROCEDURE, PUBLIC, PASS, NON_OVERRIDABLE :: FREE => GRIB2_SECTION4_107_FREE
  ...
  !>
  PROCEDURE, PUBLIC, PASS, NON_OVERRIDABLE :: PRINT => GRIB2_SECTION4_107_PRINT
...
!>
!> This function initializes a GRIB2 Section 4 object (`THIS`) using YAML configuration data (`CFG`).
!>
!> @section interface
!>   @param [inout] THIS  An object of type `GRIB2_SECTION4_107_T` representing the GRIB section being initialized.
...
#define PP_PROCEDURE_NAME 'GRIB2_SECTION4_107_INIT_CFG'
PP_THREAD_SAFE FUNCTION GRIB2_SECTION4_107_INIT_CFG( THIS, &
...
IMPLICIT NONE
  ...
  !> Dummy arguments
  CLASS(GRIB2_SECTION4_107_T),  INTENT(INOUT) :: THIS
...
END FUNCTION GRIB2_SECTION4_107_INIT_CFG
...
!> @brief Initializes GRIB2 Section 4 for a given object using the provided parameters.
!>
!> This function initializes a GRIB2 Section 4 object (`THIS`) using the provided model message (`MSG`)
!> and the provided model parameters (`PARAMS`)
!> and configuration data (`CFG`).
!>
!> @section interface
...
!>
#define PP_PROCEDURE_TYPE 'FUNCTION'
#define PP_PROCEDURE_NAME 'GRIB2_SECTION4_107_INIT_LAZY'
PP_THREAD_SAFE FUNCTION GRIB2_SECTION4_107_INIT_LAZY( THIS, &
...
IMPLICIT NONE
  ...
  ! Sice it has never been tested raise an error if we arrive here
...
!$omp critical(ERROR_HANDLER)
  ...
  BLOCK
    ...
    CASE ( ERRFLAG_NOT_IMPLEMENTED )
      PP_DEBUG_PUSH_MSG_TO_FRAME( 'lazy constructor still not implemented' )
    CASE DEFAULT
      PP_DEBUG_PUSH_MSG_TO_FRAME( 'unhandled error' )
    END SELECT
...
END FUNCTION GRIB2_SECTION4_107_INIT_LAZY
#undef PP_PROCEDURE_NAME
#undef PP_PROCEDURE_TYPE
...
!> message structure (`MSG`), into the metadata object (`METADATA`).
!>
!> @section interface
!>   @param [in]    THIS     An object of type `GRIB2_SECTION4_107_T` representing the GRIB section to allocate resources for.
!>   @param [in]    MSG      All the mars keywords needed to describe the field `FORTRAN_MESSAGE_T`.
!>   @param [in]    PAR      All information outside mars keywords needed to describe the field `PARAMETRIZATION_T`.
!>   @param [in]    OPT      The encoder options structure of type `ENCODER_OPTIONS_T`.
...
!>
#define PP_PROCEDURE_TYPE 'FUNCTION'
#define PP_PROCEDURE_NAME 'GRIB2_SECTION4_107_ALLOCATE'
PP_THREAD_SAFE FUNCTION GRIB2_SECTION4_107_ALLOCATE( THIS, &
...
END FUNCTION GRIB2_SECTION4_107_ALLOCATE
#undef PP_PROCEDURE_NAME
#undef PP_PROCEDURE_TYPE
...
!>
#define PP_PROCEDURE_TYPE 'FUNCTION'
#define PP_PROCEDURE_NAME 'GRIB2_SECTION4_107_PRESET'
PP_THREAD_SAFE FUNCTION GRIB2_SECTION4_107_PRESET( HIS, &
&  MSG, PAR, OPT,  METADATA, HOOKS ) RESULT(RET)
...
END FUNCTION GRIB2_SECTION4_107_PRESET
#undef PP_PROCEDURE_NAME
#undef PP_PROCEDURE_TYPE
...
!>
#define PP_PROCEDURE_TYPE 'FUNCTION'
#define PP_PROCEDURE_NAME 'GRIB2_SECTION4_107_RUNTIME'
PP_THREAD_SAFE FUNCTION GRIB2_SECTION4_107_RUNTIME( THIS, &
...
IMPLICIT NONE
  ...
  ! Nothing to do for section 4 runtime
...
END FUNCTION GRIB2_SECTION4_107_RUNTIME
#undef PP_PROCEDURE_NAME
#undef PP_PROCEDURE_TYPE
...
!>
!> @section interface
!>   @param [inout] THIS          An object of type `GRIB2_SECTION4_107_T` representing the GRIB section being checked.
!>   @param [in]    MSG           The message object of type `FORTRAN_MESSAGE_T` used to handle preset-related messaging.
!>   @param [in]    PAR           The parametrization structure of type `PARAMETRIZATION_T` used for the preset operation.
!>   @param [in]    TIME_HIST     The time history object of type `TIME_HISTORY_T` providing historical time data.
...
!>
#define PP_PROCEDURE_TYPE 'FUNCTION'
#define PP_PROCEDURE_NAME 'GRIB2_SECTION4_107_TO_BE_ENCODED'
PP_THREAD_SAFE FUNCTION GRIB2_SECTION4_107_TO_BE_ENCODED( HIS, &
...
IMPLICIT NONE
  ...
  ! Not condition applicable for section 4 to avoid encoding the field
  TO_BE_ENCODED = .TRUE.
...
END FUNCTION GRIB2_SECTION4_107_TO_BE_ENCODED
#undef PP_PROCEDURE_NAME
#undef PP_PROCEDURE_TYPE
...
!>
!> @section interface
!>   @param [inout] THIS  An object of type `GRIB2_SECTION4_107_T` representing the GRIB section to be freed.
!>   @param [in]    OPT   The encoder options structure of type `ENCODER_OPTIONS_T`.
...
!>
#define PP_PROCEDURE_TYPE 'FUNCTION'
#define PP_PROCEDURE_NAME 'GRIB2_SECTION4_107_FREE'
PP_THREAD_SAFE FUNCTION GRIB2_SECTION4_107_FREE( THIS, OPT, HOOKS ) RESULT(RET)
...
END FUNCTION GRIB2_SECTION4_107_FREE
#undef PP_PROCEDURE_NAME
#undef PP_PROCEDURE_TYPE
...
!>
#define PP_PROCEDURE_TYPE 'FUNCTION'
#define PP_PROCEDURE_NAME 'GRIB2_SECTION4_107_PRINT'
PP_THREAD_SAFE FUNCTION GRIB2_SECTION4_107_PRINT( THIS, &
& UNIT, OFFSET, OPT, HOOKS ) RESULT(RET)
...
IMPLICIT NONE
  ...
  IF ( OFFSET .LE. 0 ) THEN
    WRITE(UNIT,'(A,A,A,A)', IOSTAT=WRITE_STAT) 'GRIB2_SECTION4_107_T: ', TRIM(ADJUSTL(THIS%NUMBER_)), '::', TRIM(ADJUSTL(THIS%TYPE_))
    PP_DEBUG_CRITICAL_COND_THROW(WRITE_STAT.NE.0, ERRFLAG_WRITE_ERROR )
  ELSE
    WRITE(UNIT,'(A,A,A,A,A)', IOSTAT=WRITE_STAT) REPEAT(' ',OFFSET), 'GRIB2_SECTION4_107_T: ', TRIM(ADJUSTL(THIS%NUMBER_)), '::', TRIM(ADJUSTL(THIS%TYPE_))
    PP_DEBUG_CRITICAL_COND_THROW(WRITE_STAT.NE.0, ERRFLAG_WRITE_ERROR )
  ENDIF
...
END FUNCTION GRIB2_SECTION4_107_PRINT
#undef PP_PROCEDURE_NAME
#undef PP_PROCEDURE_TYPE


END MODULE GRIB2_SECTION4_107_MOD
