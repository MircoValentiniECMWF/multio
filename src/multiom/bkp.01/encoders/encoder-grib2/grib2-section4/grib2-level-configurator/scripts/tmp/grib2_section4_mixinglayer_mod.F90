...
!>
!> The `GRIB2_SECTION4_MIXINGLAYER_MOD` module contains procedures to initialize, allocate,
...
!>   - @see GRIB2_SECTION4_MIXINGLAYER_INIT
!>   - @see GRIB2_SECTION4_MIXINGLAYER_ALLOCATE
!>   - @see GRIB2_SECTION4_MIXINGLAYER_PRESET
!>   - @see GRIB2_SECTION4_MIXINGLAYER_RUNTIME
!>   - @see GRIB2_SECTION4_MIXINGLAYER_TO_BE_ENCODED
!>   - @see GRIB2_SECTION4_MIXINGLAYER_FREE
!>
...
CONTAINS
  ...
  !> GRIB2 encoder.
  !>
  PROCEDURE, PUBLIC, PASS, NON_OVERRIDABLE :: INIT_CFG => GRIB2_SECTION4_MIXINGLAYER_INIT_CFG
  ...
  !> the GRIB2 encoder.
  !>
  PROCEDURE, PUBLIC, PASS, NON_OVERRIDABLE :: INIT_LAZY => GRIB2_SECTION4_MIXINGLAYER_INIT_LAZY
  ...
  !>
  PROCEDURE, PUBLIC, PASS, NON_OVERRIDABLE :: ALLOCATE => GRIB2_SECTION4_MIXINGLAYER_ALLOCATE
  ...
  !>
  PROCEDURE, PUBLIC, PASS, NON_OVERRIDABLE :: PRESET => GRIB2_SECTION4_MIXINGLAYER_PRESET
  ...
  !>
  PROCEDURE, PUBLIC, PASS, NON_OVERRIDABLE :: RUNTIME => GRIB2_SECTION4_MIXINGLAYER_RUNTIME
  ...
  !>
  PROCEDURE, PUBLIC, PASS, NON_OVERRIDABLE :: TO_BE_ENCODED => GRIB2_SECTION4_MIXINGLAYER_TO_BE_ENCODED
  ...
  !>
  PROCEDURE, PUBLIC, PASS, NON_OVERRIDABLE :: FREE => GRIB2_SECTION4_MIXINGLAYER_FREE
  ...
  !>
  PROCEDURE, PRIVATE, PASS, NON_OVERRIDABLE :: SET_LEVELS => GRIB2_SECTION4_MIXINGLAYER_SET_LEVELS
...
#define PP_PROCEDURE_NAME 'GRIB2_SECTION4_MIXINGLAYER_INIT_CFG'
PP_THREAD_SAFE FUNCTION GRIB2_SECTION4_MIXINGLAYER_INIT_CFG( THIS, &
...
END FUNCTION GRIB2_SECTION4_MIXINGLAYER_INIT_CFG
...
!>
#define PP_PROCEDURE_TYPE 'FUNCTION'
#define PP_PROCEDURE_NAME 'GRIB2_SECTION4_MIXINGLAYER_INIT_LAZY'
PP_THREAD_SAFE FUNCTION GRIB2_SECTION4_MIXINGLAYER_INIT_LAZY( THIS, &
...
END FUNCTION GRIB2_SECTION4_MIXINGLAYER_INIT_LAZY
#undef PP_PROCEDURE_NAME
#undef PP_PROCEDURE_TYPE
...
!>
#define PP_PROCEDURE_TYPE 'FUNCTION'
#define PP_PROCEDURE_NAME 'GRIB2_SECTION4_MIXINGLAYER_ALLOCATE'
PP_THREAD_SAFE FUNCTION GRIB2_SECTION4_MIXINGLAYER_ALLOCATE( THIS, &
...
END FUNCTION GRIB2_SECTION4_MIXINGLAYER_ALLOCATE
#undef PP_PROCEDURE_NAME
#undef PP_PROCEDURE_TYPE
...
!>
#define PP_PROCEDURE_TYPE 'FUNCTION'
#define PP_PROCEDURE_NAME 'GRIB2_SECTION4_MIXINGLAYER_PRESET'
PP_THREAD_SAFE FUNCTION GRIB2_SECTION4_MIXINGLAYER_PRESET( THIS, &
&  MSG, PAR, OPT,  METADATA, HOOKS ) RESULT(RET)
...
END FUNCTION GRIB2_SECTION4_MIXINGLAYER_PRESET
#undef PP_PROCEDURE_NAME
#undef PP_PROCEDURE_TYPE
...
!>
#define PP_PROCEDURE_TYPE 'FUNCTION'
#define PP_PROCEDURE_NAME 'GRIB2_SECTION4_MIXINGLAYER_RUNTIME'
PP_THREAD_SAFE FUNCTION GRIB2_SECTION4_MIXINGLAYER_RUNTIME( THIS, &
...
END FUNCTION GRIB2_SECTION4_MIXINGLAYER_RUNTIME
#undef PP_PROCEDURE_NAME
#undef PP_PROCEDURE_TYPE
...
!>
#define PP_PROCEDURE_TYPE 'FUNCTION'
#define PP_PROCEDURE_NAME 'GRIB2_SECTION4_MIXINGLAYER_TO_BE_ENCODED'
PP_THREAD_SAFE FUNCTION GRIB2_SECTION4_MIXINGLAYER_TO_BE_ENCODED( THIS, &
...
END FUNCTION GRIB2_SECTION4_MIXINGLAYER_TO_BE_ENCODED
#undef PP_PROCEDURE_NAME
#undef PP_PROCEDURE_TYPE
...
!>
#define PP_PROCEDURE_TYPE 'FUNCTION'
#define PP_PROCEDURE_NAME 'GRIB2_SECTION4_MIXINGLAYER_FREE'
PP_THREAD_SAFE FUNCTION GRIB2_SECTION4_MIXINGLAYER_FREE( THIS, OPT, HOOKS ) RESULT(RET)
...
END FUNCTION GRIB2_SECTION4_MIXINGLAYER_FREE
#undef PP_PROCEDURE_NAME
#undef PP_PROCEDURE_TYPE
...
!>
#define PP_PROCEDURE_TYPE 'FUNCTION'
#define PP_PROCEDURE_NAME 'GRIB2_SECTION4_MIXINGLAYER_SET_LEVELS'
PP_THREAD_SAFE FUNCTION GRIB2_SECTION4_MIXINGLAYER_SET_LEVELS( THIS, &
&  MSG, PAR, OPT, METADATA, HOOKS ) RESULT(RET)
...
END FUNCTION GRIB2_SECTION4_MIXINGLAYER_SET_LEVELS
#undef PP_PROCEDURE_NAME
#undef PP_PROCEDURE_TYPE
