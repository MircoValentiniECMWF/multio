...
PP_THREAD_SAFE FUNCTION METADATA_LIST_PUSH( THIS, MSG, PAR, METADATA, HOOKS ) RESULT(RET)
...
PP_THREAD_SAFE FUNCTION METADATA_LIST_POP( THIS, MSG, PAR, METADATA, HOOKS ) RESULT(RET)
