...
CONTAINS
  ...
  PROCEDURE, NON_OVERRIDABLE, PASS, PRIVATE :: GET_MARS_FROM_ATM => GRIB_HEADER2MULTIO_READ_GET_MARS_FROM_ATM
  PROCEDURE, NON_OVERRIDABLE, PASS, PRIVATE :: GET_MARS_FROM_WAM => GRIB_HEADER2MULTIO_READ_GET_MARS_FROM_WAM
...
#define PP_PROCEDURE_TYPE 'FUNCTION'
#define PP_PROCEDURE_NAME 'GRIB_HEADER2MULTIO_READ_GET_MARS_FROM_ATM'
PP_THREAD_SAFE FUNCTION GRIB_HEADER2MULTIO_READ_GET_MARS_FROM_ATM( THIS, YDMSG, MSG, PAR, HOOKS ) RESULT(RET)
...
END FUNCTION GRIB_HEADER2MULTIO_READ_GET_MARS_FROM_ATM
#undef PP_PROCEDURE_NAME
#undef PP_PROCEDURE_TYPE
...
#define PP_PROCEDURE_TYPE 'FUNCTION'
#define PP_PROCEDURE_NAME 'GRIB_HEADER2MULTIO_READ_GET_MARS_FROM_WAM'
PP_THREAD_SAFE FUNCTION GRIB_HEADER2MULTIO_READ_GET_MARS_FROM_WAM( THIS, YDMSG, MSG, PAR, HOOKS ) RESULT(RET)
...
END FUNCTION GRIB_HEADER2MULTIO_READ_GET_MARS_FROM_WAM
#undef PP_PROCEDURE_NAME
#undef PP_PROCEDURE_TYPE
