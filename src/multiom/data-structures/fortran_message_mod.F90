...
PUBLIC :: FORTRAN_MESSAGE_READ_FROM_YAML
...
FUNCTION FORTRAN_MESSAGE_READ_FROM_YAML( MSG, MSG_CONFIG, HOOKS ) RESULT(RET)
...
IMPLICIT NONE
  ...
  !> Dummy arguments
  CLASS(FORTRAN_MESSAGE_T),   INTENT(OUT)   :: MSG
  TYPE(YAML_CONFIGURATION_T), INTENT(IN)    :: MSG_CONFIG
  TYPE(HOOKS_T),              INTENT(INOUT) :: HOOKS
