...
IMPLICIT NONE
  ...
  PP_TRYCALL(ERRFLAG_UNABLE_TO_READ_CFG) YAML_CONFIGURATION_HAS_KEY( CFG, 'tag', CONFIGURATION_HAS_NAME, HOOKS )
  PP_DEBUG_CRITICAL_COND_THROW( .NOT. CONFIGURATION_HAS_NAME, ERRFLAG_MAPPING_RULE_WITHOUT_TAG )
  ...
  PP_TRYCALL(ERRFLAG_UNABLE_TO_READ_NESTED_FILTER) MAKE_ASSIGNMENT( THIS%ASSIGNMENT_, NESTED_CTYPE, ASSIGNMENT_CFG, HOOKS )
...
PP_THREAD_SAFE FUNCTION MAPPING_RULE_GET_ASSIGNMENT( THIS, ASSIGNMENT, TAG, HOOKS ) RESULT(RET)
