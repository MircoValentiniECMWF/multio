...
PP_THREAD_SAFE FUNCTION CASHED_MAPPER_INIT_DEFAULT( THIS, ASSIGNMENT, TAG, HOOKS ) RESULT(RET)
...
PP_THREAD_SAFE FUNCTION CASHED_MAPPER_FREE( THIS, HOOKS ) RESULT(RET)
...
&                                OUT_MSG, OUT_PAR, HOOKS  ) RESULT(RET)
