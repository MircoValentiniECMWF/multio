...
INTERFACE
  PP_THREAD_SAFE FUNCTION FUNCTION_MAPPING_CACHE_IF( KEY, OPT, HOOKS ) RESULT(RET)
    ! Symbols imported from other modules within the project.
    USE :: DATAKINDS_DEF_MOD,        ONLY: JPIB_K
...
ABSTRACT INTERFACE
  PP_THREAD_SAFE FUNCTION FUNCTOR_MAPPING_CACHE_IF( THIS, KEY, OPT,  HOOKS ) RESULT(RET)
    ! Symbols imported from other modules within the project.
    USE :: DATAKINDS_DEF_MOD,        ONLY: JPIB_K
    USE :: HOOKS_MOD,                ONLY: HOOKS_T
    USE :: GRIB_ENCODER_OPTIONS_MOD, ONLY: GRIB_ENCODER_OPTIONS_T
...
&                                        MAPPERS, INSERTED, OPT, FILTER_OPT, HOOKS ) RESULT(RET)
...
&       PAR, MAPPING_RULES, OPT, FILTER_OPT, HOOKS )
...
&             KEY, PAR, MAPPING_RULES, OPT, FILTER_OPT, HOOKS )
...
PP_THREAD_SAFE FUNCTION NODE_INIT( THIS, PARENT, KEY, PAR, &
        MAPPING_RULES, ENCODER_OPT, FILTER_OPT, HOOKS ) RESULT(RET)
...
&   KEY, PAR, MAPPING_RULES, ENCODER_OPT, FILTER_OPT, THIS%MAPPERS_, HOOKS )
...
IMPLICIT NONE
  ...
  IF ( ASSOCIATED( X ) ) THEN
    ...
    PP_TRYCALL(ERRFLAG_UNABLE_TO_FREE_VAL) X%MAPPERS_%FREE( HOOKS )
...
PP_THREAD_SAFE FUNCTION MAPPING_CACHE_INIT( ENCODERS_MAP, OPT, HOOKS ) RESULT(RET)
...
PP_THREAD_SAFE FUNCTION MAPPING_CACHE_FREE( ENCODERS_MAP, OPT, HOOKS ) RESULT(RET)
...
PP_THREAD_SAFE FUNCTION MAPPING_CACHE_MINIMUM( ENCODERS_MAP, KEY, OPT, HOOKS ) RESULT(RET)
...
PP_THREAD_SAFE FUNCTION MAPPING_CACHE_MAXIMUM( ENCODERS_MAP, KEY, OPT, HOOKS ) RESULT(RET)
...
PP_THREAD_SAFE FUNCTION MAPPING_CACHE_GET_SORTED_KEYS( ENCODERS_MAP, SORTED_KEYS, OPT, HOOKS ) RESULT(RET)
...
&                                        MAPPERS, OPT, FILTER_OPT, HOOKS ) RESULT(RET)
...
&     MAPPING_RULES, MAPPERS, INSERTED, OPT, FILTER_OPT, HOOKS )
...
PP_THREAD_SAFE FUNCTION MAPPING_CACHE_MATCH( THIS, KEY, OPT, LMATCH, HOOKS ) RESULT(RET)
...
PP_THREAD_SAFE FUNCTION MAPPING_CACHE_REMOVE( THIS, KEY, OPT, HOOKS ) RESULT(RET)
...
PP_THREAD_SAFE FUNCTION MAPPING_CACHE_LIST( THIS, UNIT, PREFIX, OPT, HOOKS ) RESULT(RET)
...
PP_THREAD_SAFE FUNCTION MAPPING_CACHE_APPLY_FUNCTION( THIS, FUNCTION, OPT, HOOKS ) RESULT(RET)
...
PP_THREAD_SAFE FUNCTION MAPPING_CACHE_APPLY_FUNCTOR( THIS, FUNCTOR, OPT, HOOKS ) RESULT(RET)
...
PP_THREAD_SAFE FUNCTION MAPPING_CACHE_PRINT( THIS, NAME, IDX, OPT, HOOKS ) RESULT(RET)
