...
&       PAR, METADATA, ENCODING_RULES, OPT, HOOKS )
...
&             KEY, PAR, METADATA, ENCODING_RULES, OPT, HOOKS )
...
PP_THREAD_SAFE FUNCTION NODE_INIT( THIS, PARENT, KEY, PAR, &
        METADATA, ENCODING_RULES, OPT, HOOKS ) RESULT(RET)
...
&  KEY, PAR, METADATA, ENCODING_RULES, OPT, THIS%ENCODERS_, HOOKS )
...
IMPLICIT NONE
  ...
  IF ( ASSOCIATED( X ) ) THEN
    ...
    IF ( ASSOCIATED(X%ENCODERS_) ) THEN
      PP_TRYCALL(ERRFLAG_UNABLE_TO_FREE_VAL) X%ENCODERS_%FREE( OPT, HOOKS )
