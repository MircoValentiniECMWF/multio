...
CONTAINS
  ...
  !>
  PROCEDURE, PUBLIC, PASS, NON_OVERRIDABLE :: PRINT => GRIB2_SECTION2_024_PRINT
...
PP_THREAD_SAFE FUNCTION GRIB2_SECTION2_024_INIT( THIS, PAR, &
...
PP_THREAD_SAFE FUNCTION GRIB2_SECTION2_024_ALLOCATE( THIS, PAR, &
...
PP_THREAD_SAFE FUNCTION GRIB2_SECTION2_024_PRESET( THIS, PAR, &
&   MSG, METADATA, HOOKS ) RESULT(RET)
...
PP_THREAD_SAFE FUNCTION GRIB2_SECTION2_024_RUNTIME( THIS, PAR, &
...
PP_THREAD_SAFE FUNCTION GRIB2_SECTION2_024_TO_BE_ENCODED( THIS, PAR, &
...
PP_THREAD_SAFE FUNCTION GRIB2_SECTION2_024_FREE( THIS, HOOKS ) RESULT(RET)
...
!>
#define PP_PROCEDURE_TYPE 'FUNCTION'
#define PP_PROCEDURE_NAME 'GRIB2_SECTION2_024_PRINT'
PP_THREAD_SAFE FUNCTION GRIB2_SECTION2_024_PRINT( THIS, UNIT, OFFSET, HOOKS ) RESULT(RET)
...
IMPLICIT NONE
  ...
  IF ( OFFSET .LE. 0 ) THEN
    WRITE(UNIT,'(A,A,A,A)', IOSTAT=WRITE_STAT) 'GRIB2_SECTION2_024_T: ', TRIM(ADJUSTL(THIS%NUMBER_)), '::', TRIM(ADJUSTL(THIS%TYPE_))
    PP_DEBUG_CRITICAL_COND_THROW(WRITE_STAT.NE.0, ERRFLAG_WRITE_ERROR )
  ELSE
    WRITE(UNIT,'(A,A,A,A,A)', IOSTAT=WRITE_STAT) REPEAT(' ',OFFSET), 'GRIB2_SECTION2_024_T: ', TRIM(ADJUSTL(THIS%NUMBER_)), '::', TRIM(ADJUSTL(THIS%TYPE_))
    PP_DEBUG_CRITICAL_COND_THROW(WRITE_STAT.NE.0, ERRFLAG_WRITE_ERROR )
  ENDIF
...
END FUNCTION GRIB2_SECTION2_024_PRINT
#undef PP_PROCEDURE_NAME
#undef PP_PROCEDURE_TYPE
