!>
!> @file grib2_section2_030_mod.F90
!>
!> @brief Module for managing GRIB2 Section 2 operations.
!>
!> The `GRIB2_SECTION2_030_MOD` module contains procedures to initialize, allocate,
...
!>   - @see GRIB2_SECTION2_030_INIT
!>   - @see GRIB2_SECTION2_030_ALLOCATE
!>   - @see GRIB2_SECTION2_030_PRESET
!>   - @see GRIB2_SECTION2_030_RUNTIME
!>   - @see GRIB2_SECTION2_030_TO_BE_ENCODED
!>   - @see GRIB2_SECTION2_030_FREE
!>
...
#define PP_FILE_NAME 'grib2_section2_030_mod.F90'
#define PP_SECTION_TYPE 'MODULE'
#define PP_SECTION_NAME 'GRIB2_SECTION2_030_MOD'
MODULE GRIB2_SECTION2_030_MOD
...
!>
!> The `GRIB2_SECTION2_030_T` type extends the base class `GRIB_SECTION_BASE_A` and
...
!> environments.
!>
TYPE, EXTENDS(GRIB_SECTION_BASE_A) :: GRIB2_SECTION2_030_T
...
CONTAINS
  ...
  !> object for use.
  !>
  PROCEDURE, PUBLIC, PASS, NON_OVERRIDABLE :: INIT => GRIB2_SECTION2_030_INIT
  ...
  !>
  PROCEDURE, PUBLIC, PASS, NON_OVERRIDABLE :: ALLOCATE => GRIB2_SECTION2_030_ALLOCATE
  ...
  !>
  PROCEDURE, PUBLIC, PASS, NON_OVERRIDABLE :: PRESET => GRIB2_SECTION2_030_PRESET
  ...
  !>
  PROCEDURE, PUBLIC, PASS, NON_OVERRIDABLE :: RUNTIME => GRIB2_SECTION2_030_RUNTIME
  ...
  !>
  PROCEDURE, PUBLIC, PASS, NON_OVERRIDABLE :: TO_BE_ENCODED => GRIB2_SECTION2_030_TO_BE_ENCODED
  ...
  !>
  PROCEDURE, PUBLIC, PASS, NON_OVERRIDABLE :: FREE => GRIB2_SECTION2_030_FREE
  ...
  !>
  PROCEDURE, PUBLIC, PASS, NON_OVERRIDABLE :: PRINT => GRIB2_SECTION2_030_PRINT
...
#define PP_PROCEDURE_NAME 'GRIB2_SECTION2_030_INIT'
PP_THREAD_SAFE FUNCTION GRIB2_SECTION2_030_INIT( THIS, PAR, &
...
IMPLICIT NONE
  ...
  !> Dummy arguments
  CLASS(GRIB2_SECTION2_030_T),  INTENT(INOUT) :: THIS
...
END FUNCTION GRIB2_SECTION2_030_INIT
...
!>
#define PP_PROCEDURE_TYPE 'FUNCTION'
#define PP_PROCEDURE_NAME 'GRIB2_SECTION2_030_ALLOCATE'
PP_THREAD_SAFE FUNCTION GRIB2_SECTION2_030_ALLOCATE( THIS, PAR, &
...
END FUNCTION GRIB2_SECTION2_030_ALLOCATE
#undef PP_PROCEDURE_NAME
#undef PP_PROCEDURE_TYPE
...
!>
#define PP_PROCEDURE_TYPE 'FUNCTION'
#define PP_PROCEDURE_NAME 'GRIB2_SECTION2_030_PRESET'
PP_THREAD_SAFE FUNCTION GRIB2_SECTION2_030_PRESET( THIS, PAR, &
&   MSG, METADATA, HOOKS ) RESULT(RET)
...
END FUNCTION GRIB2_SECTION2_030_PRESET
#undef PP_PROCEDURE_NAME
#undef PP_PROCEDURE_TYPE
...
!>
#define PP_PROCEDURE_TYPE 'FUNCTION'
#define PP_PROCEDURE_NAME 'GRIB2_SECTION2_030_RUNTIME'
PP_THREAD_SAFE FUNCTION GRIB2_SECTION2_030_RUNTIME( THIS, PAR, &
...
END FUNCTION GRIB2_SECTION2_030_RUNTIME
#undef PP_PROCEDURE_NAME
#undef PP_PROCEDURE_TYPE
...
!>
#define PP_PROCEDURE_TYPE 'FUNCTION'
#define PP_PROCEDURE_NAME 'GRIB2_SECTION2_030_TO_BE_ENCODED'
PP_THREAD_SAFE FUNCTION GRIB2_SECTION2_030_TO_BE_ENCODED( THIS, PAR, &
...
END FUNCTION GRIB2_SECTION2_030_TO_BE_ENCODED
#undef PP_PROCEDURE_NAME
#undef PP_PROCEDURE_TYPE
...
!>
#define PP_PROCEDURE_TYPE 'FUNCTION'
#define PP_PROCEDURE_NAME 'GRIB2_SECTION2_030_FREE'
PP_THREAD_SAFE FUNCTION GRIB2_SECTION2_030_FREE( THIS, HOOKS ) RESULT(RET)
...
END FUNCTION GRIB2_SECTION2_030_FREE
#undef PP_PROCEDURE_NAME
#undef PP_PROCEDURE_TYPE
...
!>
#define PP_PROCEDURE_TYPE 'FUNCTION'
#define PP_PROCEDURE_NAME 'GRIB2_SECTION2_030_PRINT'
PP_THREAD_SAFE FUNCTION GRIB2_SECTION2_030_PRINT( THIS, UNIT, OFFSET, HOOKS ) RESULT(RET)
...
IMPLICIT NONE
  ...
  IF ( OFFSET .LE. 0 ) THEN
    WRITE(UNIT,'(A,A,A,A)', IOSTAT=WRITE_STAT) 'GRIB2_SECTION2_030_T: ', TRIM(ADJUSTL(THIS%NUMBER_)), '::', TRIM(ADJUSTL(THIS%TYPE_))
    PP_DEBUG_CRITICAL_COND_THROW(WRITE_STAT.NE.0, ERRFLAG_WRITE_ERROR )
  ELSE
    WRITE(UNIT,'(A,A,A,A,A)', IOSTAT=WRITE_STAT) REPEAT(' ',OFFSET), 'GRIB2_SECTION2_030_T: ', TRIM(ADJUSTL(THIS%NUMBER_)), '::', TRIM(ADJUSTL(THIS%TYPE_))
    PP_DEBUG_CRITICAL_COND_THROW(WRITE_STAT.NE.0, ERRFLAG_WRITE_ERROR )
  ENDIF
...
END FUNCTION GRIB2_SECTION2_030_PRINT
#undef PP_PROCEDURE_NAME
#undef PP_PROCEDURE_TYPE


END MODULE GRIB2_SECTION2_030_MOD
