...
PUBLIC :: READ_GRIB2_SECTION2_TYPE
...
#define PP_PROCEDURE_NAME 'MAKE_GRIB2_SECTION2'
PP_THREAD_SAFE FUNCTION MAKE_GRIB2_SECTION2( GRIB2_SECTION2, ID, PAR, &
&               CFG, OPT, HOOKS ) RESULT(RET)
  ...
  USE :: GRIB2_SECTION2_007_MOD,   ONLY: GRIB2_SECTION2_007_T
  USE :: GRIB2_SECTION2_009_MOD,   ONLY: GRIB2_SECTION2_009_T
  USE :: GRIB2_SECTION2_015_MOD,   ONLY: GRIB2_SECTION2_015_T
  USE :: GRIB2_SECTION2_018_MOD,   ONLY: GRIB2_SECTION2_018_T
  USE :: GRIB2_SECTION2_023_MOD,   ONLY: GRIB2_SECTION2_023_T
  USE :: GRIB2_SECTION2_024_MOD,   ONLY: GRIB2_SECTION2_024_T
  USE :: GRIB2_SECTION2_026_MOD,   ONLY: GRIB2_SECTION2_026_T
  USE :: GRIB2_SECTION2_027_MOD,   ONLY: GRIB2_SECTION2_027_T
  USE :: GRIB2_SECTION2_030_MOD,   ONLY: GRIB2_SECTION2_030_T
  USE :: GRIB2_SECTION2_036_MOD,   ONLY: GRIB2_SECTION2_036_T
  USE :: GRIB2_SECTION2_192_MOD,   ONLY: GRIB2_SECTION2_192_T
...
IMPLICIT NONE
  ...
  CASE( 7 )
    ...
    ALLOCATE( GRIB2_SECTION2_007_T::GRIB2_SECTION2 , STAT=ALLOC_STATUS, ERRMSG=ERRMSG )
    PP_DEBUG_CRITICAL_COND_THROW( ALLOC_STATUS.NE.0, ERRFLAG_ALLOCATION_ERROR )

  CASE( 9 )

    ALLOCATE( GRIB2_SECTION2_009_T::GRIB2_SECTION2, STAT=ALLOC_STATUS, ERRMSG=ERRMSG )
    PP_DEBUG_CRITICAL_COND_THROW( ALLOC_STATUS.NE.0, ERRFLAG_ALLOCATION_ERROR )
  ...
  CASE( 18 )
    ...
    ALLOCATE( GRIB2_SECTION2_018_T::GRIB2_SECTION2, STAT=ALLOC_STATUS, ERRMSG=ERRMSG )
    PP_DEBUG_CRITICAL_COND_THROW( ALLOC_STATUS.NE.0, ERRFLAG_ALLOCATION_ERROR )

  CASE( 23 )

    ALLOCATE( GRIB2_SECTION2_023_T::GRIB2_SECTION2 , STAT=ALLOC_STATUS, ERRMSG=ERRMSG )
    PP_DEBUG_CRITICAL_COND_THROW( ALLOC_STATUS.NE.0, ERRFLAG_ALLOCATION_ERROR )
  ...
  CASE( 26 )
    ...
    ALLOCATE( GRIB2_SECTION2_026_T::GRIB2_SECTION2, STAT=ALLOC_STATUS, ERRMSG=ERRMSG )
    PP_DEBUG_CRITICAL_COND_THROW( ALLOC_STATUS.NE.0, ERRFLAG_ALLOCATION_ERROR )

  CASE( 27 )

    ALLOCATE( GRIB2_SECTION2_027_T::GRIB2_SECTION2, STAT=ALLOC_STATUS, ERRMSG=ERRMSG )
    PP_DEBUG_CRITICAL_COND_THROW( ALLOC_STATUS.NE.0, ERRFLAG_ALLOCATION_ERROR )

  CASE( 30 )

    ALLOCATE( GRIB2_SECTION2_030_T::GRIB2_SECTION2, STAT=ALLOC_STATUS, ERRMSG=ERRMSG )
    PP_DEBUG_CRITICAL_COND_THROW( ALLOC_STATUS.NE.0, ERRFLAG_ALLOCATION_ERROR )
  ...
  CASE( 192 )
    ...
    ALLOCATE( GRIB2_SECTION2_192_T::GRIB2_SECTION2, STAT=ALLOC_STATUS, ERRMSG=ERRMSG )
    PP_DEBUG_CRITICAL_COND_THROW( ALLOC_STATUS.NE.0, ERRFLAG_ALLOCATION_ERROR )
  ...
  PP_TRYCALL(ERRFLAG_INITIALIZATION_ERROR)  GRIB2_SECTION2%INIT( PAR, CFG, OPT, HOOKS )
...
END FUNCTION MAKE_GRIB2_SECTION2
...
PP_THREAD_SAFE FUNCTION DESTROY_GRIB2_SECTION2( GRIB2_SECTION2, HOOKS ) RESULT(RET)
...
IMPLICIT NONE
  ...
  !> Free the section
  PP_TRYCALL(ERRFLAG_FREE_ERROR)  GRIB2_SECTION2%FREE( HOOKS )
...
!>
#define PP_PROCEDURE_TYPE 'FUNCTION'
#define PP_PROCEDURE_NAME 'READ_GRIB2_SECTION2_TYPE'
PP_THREAD_SAFE FUNCTION READ_GRIB2_SECTION2_TYPE( CFG, SECTION2_TYPE, HOOKS ) RESULT(RET)
...
!$omp critical(ERROR_HANDLER)
  ...
  BLOCK
    ...
    CASE (ERRFLAG_DEALLOCATION_ERROR)
      ...
      ELSE
        PP_DEBUG_PUSH_MSG_TO_FRAME( 'error deallocating SECTION2 number: '//TRIM(ADJUSTL(ERRMSG)) )
        DEALLOCATE(ERRMSG)
      ENDIF
...
END FUNCTION READ_GRIB2_SECTION2_TYPE
#undef PP_PROCEDURE_NAME
#undef PP_PROCEDURE_TYPE
