...
PUBLIC :: READ_GRIB2_SECTION1_TYPE
...
#define PP_PROCEDURE_NAME 'MAKE_GRIB2_SECTION1'
PP_THREAD_SAFE FUNCTION MAKE_GRIB2_SECTION1( GRIB2_SECTION1, ID, PAR, &
...
IMPLICIT NONE
  ...
  PP_TRYCALL(ERRFLAG_INITIALIZATION_ERROR)  GRIB2_SECTION1%INIT( PAR, CFG, OPT, HOOKS )
...
END FUNCTION MAKE_GRIB2_SECTION1
...
PP_THREAD_SAFE FUNCTION DESTROY_GRIB2_SECTION1( GRIB2_SECTION1, HOOKS ) RESULT(RET)
...
IMPLICIT NONE
  ...
  !> Free the section
  PP_TRYCALL(ERRFLAG_FREE_ERROR)  GRIB2_SECTION1%FREE( HOOKS )
...
!>
#define PP_PROCEDURE_TYPE 'FUNCTION'
#define PP_PROCEDURE_NAME 'READ_GRIB2_SECTION1_TYPE'
PP_THREAD_SAFE FUNCTION READ_GRIB2_SECTION1_TYPE( CFG, SECTION1_TYPE, HOOKS ) RESULT(RET)
...
!$omp critical(ERROR_HANDLER)
  ...
  BLOCK
    ...
    CASE (ERRFLAG_DEALLOCATION_ERROR)
      ...
      ELSE
        PP_DEBUG_PUSH_MSG_TO_FRAME( 'error deallocating SECTION1 number: '//TRIM(ADJUSTL(ERRMSG)) )
        DEALLOCATE(ERRMSG)
      ENDIF
...
END FUNCTION READ_GRIB2_SECTION1_TYPE
#undef PP_PROCEDURE_NAME
#undef PP_PROCEDURE_TYPE
