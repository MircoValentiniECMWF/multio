...
PUBLIC :: READ_GRIB2_SECTION0_TYPE
...
#define PP_PROCEDURE_NAME 'MAKE_GRIB2_SECTION0'
PP_THREAD_SAFE FUNCTION MAKE_GRIB2_SECTION0( GRIB2_SECTION0, ID, PAR, &
...
IMPLICIT NONE
  ...
  PP_TRYCALL(ERRFLAG_INITIALIZATION_ERROR)  GRIB2_SECTION0%INIT( PAR, CFG, OPT, HOOKS )
...
END FUNCTION MAKE_GRIB2_SECTION0
...
PP_THREAD_SAFE FUNCTION DESTROY_GRIB2_SECTION0( GRIB2_SECTION0, HOOKS ) RESULT(RET)
...
IMPLICIT NONE
  ...
  !> Free the section
  PP_TRYCALL(ERRFLAG_FREE_ERROR)  GRIB2_SECTION0%FREE( HOOKS )
...
!>
#define PP_PROCEDURE_TYPE 'FUNCTION'
#define PP_PROCEDURE_NAME 'READ_GRIB2_SECTION0_TYPE'
PP_THREAD_SAFE FUNCTION READ_GRIB2_SECTION0_TYPE( CFG, SECTION0_TYPE, HOOKS ) RESULT(RET)
...
END FUNCTION READ_GRIB2_SECTION0_TYPE
#undef PP_PROCEDURE_NAME
#undef PP_PROCEDURE_TYPE
