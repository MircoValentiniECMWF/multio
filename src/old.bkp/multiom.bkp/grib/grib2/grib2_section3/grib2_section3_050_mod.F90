...
PP_THREAD_SAFE FUNCTION GRIB2_SECTION3_050_INIT( THIS, PAR, &
...
PP_THREAD_SAFE FUNCTION GRIB2_SECTION3_050_ALLOCATE( THIS, PAR, &
...
PP_THREAD_SAFE FUNCTION GRIB2_SECTION3_050_PRESET( THIS, PAR, &
&   MSG, METADATA, HOOKS ) RESULT(RET)
...
PP_THREAD_SAFE FUNCTION GRIB2_SECTION3_050_RUNTIME( THIS, PAR, &
...
PP_THREAD_SAFE FUNCTION GRIB2_SECTION3_050_TO_BE_ENCODED( THIS, PAR, &
...
PP_THREAD_SAFE FUNCTION GRIB2_SECTION3_050_FREE( THIS, HOOKS ) RESULT(RET)
...
PP_THREAD_SAFE FUNCTION GRIB2_SECTION3_050_PRINT( THIS, UNIT, OFFSET, HOOKS ) RESULT(RET)
