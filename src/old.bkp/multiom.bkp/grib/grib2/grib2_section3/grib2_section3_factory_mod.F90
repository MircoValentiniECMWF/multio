...
PUBLIC :: READ_GRIB2_SECTION3_TYPE
...
#define PP_PROCEDURE_NAME 'MAKE_GRIB2_SECTION3'
PP_THREAD_SAFE FUNCTION MAKE_GRIB2_SECTION3( GRIB2_SECTION3, ID, PAR, &
...
IMPLICIT NONE
  ...
  PP_TRYCALL(ERRFLAG_INITIALIZATION_ERROR)  GRIB2_SECTION3%INIT( PAR, CFG, OPT, HOOKS )
...
!$omp critical(ERROR_HANDLER)
  ...
  BLOCK
    ...
    CASE (ERRFLAG_ALLOCATION_ERROR)
      ...
      ELSE
        PP_DEBUG_PUSH_MSG_TO_FRAME( 'error allocating section3 number: '//TRIM(ADJUSTL(TMP))//' : '//TRIM(ADJUSTL(ERRMSG)) )
        DEALLOCATE(ERRMSG)
      ENDIF
...
END FUNCTION MAKE_GRIB2_SECTION3
...
PP_THREAD_SAFE FUNCTION DESTROY_GRIB2_SECTION3( GRIB2_SECTION3, HOOKS ) RESULT(RET)
...
IMPLICIT NONE
  ...
  !> Free the section
  PP_TRYCALL(ERRFLAG_FREE_ERROR)  GRIB2_SECTION3%FREE( HOOKS )
...
!$omp critical(ERROR_HANDLER)
  ...
  BLOCK
    ...
    CASE (ERRFLAG_DEALLOCATION_ERROR)
      ...
      ELSE
        PP_DEBUG_PUSH_MSG_TO_FRAME( 'error deallocating section3 number: '//TRIM(ADJUSTL(ERRMSG)) )
        DEALLOCATE(ERRMSG)
      ENDIF
...
!>
#define PP_PROCEDURE_TYPE 'FUNCTION'
#define PP_PROCEDURE_NAME 'READ_GRIB2_SECTION3_TYPE'
PP_THREAD_SAFE FUNCTION READ_GRIB2_SECTION3_TYPE( CFG, SECTION3_TYPE, HOOKS ) RESULT(RET)
...
END FUNCTION READ_GRIB2_SECTION3_TYPE
#undef PP_PROCEDURE_NAME
#undef PP_PROCEDURE_TYPE
