!>
!> @file grib2_level_configurator_053_mod.F90
!>
!> @brief Module for managing GRIB2 level configurator operations.
!>
!> The `GRIB2_LEVEL_CONFIGURATOR_053_MOD` module contains procedures to initialize, allocate,
...
!>   - @see GRIB2_LEVEL_CONFIGURATOR_053_INIT
!>   - @see GRIB2_LEVEL_CONFIGURATOR_053_ALLOCATE
!>   - @see GRIB2_LEVEL_CONFIGURATOR_053_PRESET
!>   - @see GRIB2_LEVEL_CONFIGURATOR_053_RUNTIME
!>   - @see GRIB2_LEVEL_CONFIGURATOR_053_TO_BE_ENCODED
!>   - @see GRIB2_LEVEL_CONFIGURATOR_053_FREE
!>
...
#define PP_FILE_NAME 'grib2_level_configurator_053_mod.F90'
#define PP_SECTION_TYPE 'MODULE'
#define PP_SECTION_NAME 'GRIB2_LEVEL_CONFIGURATOR_053_MOD'
MODULE GRIB2_LEVEL_CONFIGURATOR_053_MOD
...
!>
!> The `GRIB2_LEVEL_CONFIGURATOR_053_T` type extends the base class `GRIB_SECTION_BASE_A` and
...
!> environments.
!>
TYPE, EXTENDS(GRIB_SECTION_BASE_A) :: GRIB2_LEVEL_CONFIGURATOR_053_T
...
CONTAINS
  ...
  !> object for use.
  !>
  PROCEDURE, PUBLIC, PASS, NON_OVERRIDABLE :: INIT => GRIB2_LEVEL_CONFIGURATOR_053_INIT
  ...
  !>
  PROCEDURE, PUBLIC, PASS, NON_OVERRIDABLE :: ALLOCATE => GRIB2_LEVEL_CONFIGURATOR_053_ALLOCATE
  ...
  !>
  PROCEDURE, PUBLIC, PASS, NON_OVERRIDABLE :: PRESET => GRIB2_LEVEL_CONFIGURATOR_053_PRESET
  ...
  !>
  PROCEDURE, PUBLIC, PASS, NON_OVERRIDABLE :: RUNTIME => GRIB2_LEVEL_CONFIGURATOR_053_RUNTIME
  ...
  !>
  PROCEDURE, PUBLIC, PASS, NON_OVERRIDABLE :: TO_BE_ENCODED => GRIB2_LEVEL_CONFIGURATOR_053_TO_BE_ENCODED
  ...
  !>
  PROCEDURE, PUBLIC, PASS, NON_OVERRIDABLE :: FREE => GRIB2_LEVEL_CONFIGURATOR_053_FREE
  ...
  !>
  PROCEDURE, PUBLIC, PASS, NON_OVERRIDABLE :: PRINT => GRIB2_LEVEL_CONFIGURATOR_053_PRINT
...
PUBLIC :: GRIB2_LEVEL_CONFIGURATOR_053_T
...
#define PP_PROCEDURE_NAME 'GRIB2_LEVEL_CONFIGURATOR_053_INIT'
PP_THREAD_SAFE FUNCTION GRIB2_LEVEL_CONFIGURATOR_053_INIT( THIS, PAR, &
...
IMPLICIT NONE
  ...
  !> Dummy arguments
  CLASS(GRIB2_LEVEL_CONFIGURATOR_053_T),  INTENT(INOUT) :: THIS
...
END FUNCTION GRIB2_LEVEL_CONFIGURATOR_053_INIT
...
!>
#define PP_PROCEDURE_TYPE 'FUNCTION'
#define PP_PROCEDURE_NAME 'GRIB2_LEVEL_CONFIGURATOR_053_ALLOCATE'
PP_THREAD_SAFE FUNCTION GRIB2_LEVEL_CONFIGURATOR_053_ALLOCATE( THIS, PAR, &
...
END FUNCTION GRIB2_LEVEL_CONFIGURATOR_053_ALLOCATE
#undef PP_PROCEDURE_NAME
#undef PP_PROCEDURE_TYPE
...
!>
#define PP_PROCEDURE_TYPE 'FUNCTION'
#define PP_PROCEDURE_NAME 'GRIB2_LEVEL_CONFIGURATOR_053_PRESET'
PP_THREAD_SAFE FUNCTION GRIB2_LEVEL_CONFIGURATOR_053_PRESET( THIS, PAR, &
&   MSG, METADATA, HOOKS ) RESULT(RET)
...
END FUNCTION GRIB2_LEVEL_CONFIGURATOR_053_PRESET
#undef PP_PROCEDURE_NAME
#undef PP_PROCEDURE_TYPE
...
!>
#define PP_PROCEDURE_TYPE 'FUNCTION'
#define PP_PROCEDURE_NAME 'GRIB2_LEVEL_CONFIGURATOR_053_RUNTIME'
PP_THREAD_SAFE FUNCTION GRIB2_LEVEL_CONFIGURATOR_053_RUNTIME( THIS, PAR, &
...
END FUNCTION GRIB2_LEVEL_CONFIGURATOR_053_RUNTIME
#undef PP_PROCEDURE_NAME
#undef PP_PROCEDURE_TYPE
...
!>
#define PP_PROCEDURE_TYPE 'FUNCTION'
#define PP_PROCEDURE_NAME 'GRIB2_LEVEL_CONFIGURATOR_053_TO_BE_ENCODED'
PP_THREAD_SAFE FUNCTION GRIB2_LEVEL_CONFIGURATOR_053_TO_BE_ENCODED( THIS, PAR, &
...
END FUNCTION GRIB2_LEVEL_CONFIGURATOR_053_TO_BE_ENCODED
#undef PP_PROCEDURE_NAME
#undef PP_PROCEDURE_TYPE
...
!>
#define PP_PROCEDURE_TYPE 'FUNCTION'
#define PP_PROCEDURE_NAME 'GRIB2_LEVEL_CONFIGURATOR_053_FREE'
PP_THREAD_SAFE FUNCTION GRIB2_LEVEL_CONFIGURATOR_053_FREE( THIS, HOOKS ) RESULT(RET)
...
END FUNCTION GRIB2_LEVEL_CONFIGURATOR_053_FREE
#undef PP_PROCEDURE_NAME
#undef PP_PROCEDURE_TYPE
...
!>
#define PP_PROCEDURE_TYPE 'FUNCTION'
#define PP_PROCEDURE_NAME 'GRIB2_LEVEL_CONFIGURATOR_053_PRINT'
PP_THREAD_SAFE FUNCTION GRIB2_LEVEL_CONFIGURATOR_053_PRINT( THIS, UNIT, OFFSET, HOOKS ) RESULT(RET)
...
IMPLICIT NONE
  ...
  IF ( OFFSET .LE. 0 ) THEN
    WRITE(UNIT,'(A,A,A,A)', IOSTAT=WRITE_STAT) 'GRIB2_LEVEL_CONFIGURATOR_053_T: ', TRIM(ADJUSTL(THIS%NUMBER_)), '::', TRIM(ADJUSTL(THIS%TYPE_))
    PP_DEBUG_CRITICAL_COND_THROW(WRITE_STAT.NE.0, ERRFLAG_WRITE_ERROR )
  ELSE
    WRITE(UNIT,'(A,A,A,A,A)', IOSTAT=WRITE_STAT) REPEAT(' ',OFFSET), 'GRIB2_LEVEL_CONFIGURATOR_053_T: ', TRIM(ADJUSTL(THIS%NUMBER_)), '::', TRIM(ADJUSTL(THIS%TYPE_))
    PP_DEBUG_CRITICAL_COND_THROW(WRITE_STAT.NE.0, ERRFLAG_WRITE_ERROR )
  ENDIF
...
END FUNCTION GRIB2_LEVEL_CONFIGURATOR_053_PRINT
#undef PP_PROCEDURE_NAME
#undef PP_PROCEDURE_TYPE


END MODULE GRIB2_LEVEL_CONFIGURATOR_053_MOD
