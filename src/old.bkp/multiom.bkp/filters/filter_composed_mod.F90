...
PP_THREAD_SAFE FUNCTION FILTER_COMPOSED_INIT( THIS, CFG, HOOKS ) RESULT(RET)
...
IMPLICIT NONE
  ...
  WRITE(UNIT,*) REPEAT(' ',OFFSET)//'COMPOSED FILTER: '//TRIM(ADJUSTL(OPERATION_TYPE_STR))//'('
