...
IMPLICIT NONE
  ...
  INTEGER(KIND=JPIB_K) :: INDICATOR_SECTION_TYPE
  ...
  !> Read the indicator-section type
  PP_TRYCALL(ERRFLAG_UNABLE_TO_READ_SEC0_TYPE) READ_GRIB2_SECTION0_TYPE( INDICATOR_SECTION_CFG, INDICATOR_SECTION_TYPE, HOOKS )

  !> Make the indicator-section
  PP_TRYCALL(ERRFLAG_UNABLE_TO_MAKE_SEC0) MAKE_GRIB2_SECTION0( THIS%INDICATOR_SECTION_, INDICATOR_SECTION_TYPE, INDICATOR_SECTION_CFG, ENCODER_OPT, HOOKS )
...
IMPLICIT NONE
  ...
  INTEGER(KIND=JPIB_K) :: IDENTIFICATION_SECTION_TYPE
  ...
  !> Read the identification-section type
  PP_TRYCALL(ERRFLAG_UNABLE_TO_READ_SEC1_TYPE) READ_GRIB2_SECTION1_TYPE( IDENTIFICATION_SECTION_CFG, IDENTIFICATION_SECTION_TYPE, HOOKS )

  !> Make the identification-section
  PP_TRYCALL(ERRFLAG_UNABLE_TO_MAKE_SEC1) MAKE_GRIB2_SECTION1( THIS%IDENTIFICATION_SECTION_, IDENTIFICATION_SECTION_TYPE, IDENTIFICATION_SECTION_CFG, ENCODER_OPT, HOOKS )
...
IMPLICIT NONE
  ...
  INTEGER(KIND=JPIB_K) :: LOCAL_USE_SECTION_TYPE
  ...
  !> Read the local-use-section type
  PP_TRYCALL(ERRFLAG_UNABLE_TO_READ_SEC2_TYPE) READ_GRIB2_SECTION2_TYPE( LOCAL_USE_SECTION_CFG, LOCAL_USE_SECTION_TYPE, HOOKS )

  !> Make the local-use-section
  PP_TRYCALL(ERRFLAG_UNABLE_TO_MAKE_SEC2) MAKE_GRIB2_SECTION2( THIS%LOCAL_USE_SECTION_, LOCAL_USE_SECTION_TYPE, LOCAL_USE_SECTION_CFG, ENCODER_OPT, HOOKS )
...
IMPLICIT NONE
  ...
  INTEGER(KIND=JPIB_K) :: GRID_DEFINITION_SECTION_TYPE
  ...
  !> Read the grid-definition-section type
  PP_TRYCALL(ERRFLAG_UNABLE_TO_READ_SEC3_TYPE) READ_GRIB2_SECTION3_TYPE( GRID_DEFINITION_SECTION_CFG, GRID_DEFINITION_SECTION_TYPE, HOOKS )

  !> Make the grid-definition-section
  PP_TRYCALL(ERRFLAG_UNABLE_TO_MAKE_SEC3) MAKE_GRIB2_SECTION3( THIS%GRID_DEFINITION_SECTION_, GRID_DEFINITION_SECTION_TYPE, GRID_DEFINITION_SECTION_CFG, ENCODER_OPT, HOOKS )
...
IMPLICIT NONE
  ...
  INTEGER(KIND=JPIB_K) :: PRODUCT_DEFINITION_SECTION_TYPE
  ...
  !> Read the product-definition-section type
  PP_TRYCALL(ERRFLAG_UNABLE_TO_READ_SEC4_TYPE) READ_GRIB2_SECTION4_TYPE( PRODUCT_DEFINITION_SECTION_CFG, PRODUCT_DEFINITION_SECTION_TYPE, HOOKS )

  !> Make the product-definition-section
  PP_TRYCALL(ERRFLAG_UNABLE_TO_MAKE_SEC4) MAKE_GRIB2_SECTION4( THIS%PRODUCT_DEFINITION_SECTION_, PRODUCT_DEFINITION_SECTION_TYPE, PRODUCT_DEFINITION_SECTION_CFG, ENCODER_OPT, HOOKS )
...
IMPLICIT NONE
  ...
  INTEGER(KIND=JPIB_K) :: DATA_REPRESENTATION_SECTION_TYPE
  ...
  INTEGER(KIND=JPIB_K), PARAMETER :: ERRFLAG_UNABLE_TO_READ_SEC5_TYPE = 6_JPIB_K
  ...
  !> Read the data-represntation-section type
  PP_TRYCALL(ERRFLAG_UNABLE_TO_READ_SEC5_TYPE) READ_GRIB2_SECTION5_TYPE( DATA_REPRESENTATION_SECTION_CFG, DATA_REPRESENTATION_SECTION_TYPE, HOOKS )

  !> Make the data-represntation-section
  PP_TRYCALL(ERRFLAG_UNABLE_TO_MAKE_SEC5) MAKE_GRIB2_SECTION5( THIS%DATA_REPRESENTATION_SECTION_, DATA_REPRESENTATION_SECTION_TYPE, DATA_REPRESENTATION_SECTION_CFG, ENCODER_OPT, HOOKS )
...
!$omp critical(ERROR_HANDLER)
  ...
  BLOCK
    ...
    CASE (ERRFLAG_UNABLE_TO_READ_SEC5_TYPE)
      PP_DEBUG_PUSH_MSG_TO_FRAME( 'unable to read data-represntation-section' )
...
IMPLICIT NONE
  ...
  PP_TRYCALL(ERRFLAG_CALL_SEC0_ALLOC)  THIS%INDICATOR_SECTION_%ALLOCATE( PAR, MSG, METADATA, HOOKS )
  PP_TRYCALL(EERRFLAG_CALL_SEC1_ALLOC) THIS%IDENTIFICATION_SECTION_%ALLOCATE( PAR, MSG, METADATA, HOOKS )
  PP_TRYCALL(EERRFLAG_CALL_SEC2_ALLOC) THIS%LOCAL_USE_SECTION_%ALLOCATE( PAR, MSG, METADATA, HOOKS )
  PP_TRYCALL(ERRFLAG_CALL_SEC3_ALLOC)  THIS%GRID_DEFINITION_SECTION_%ALLOCATE( PAR, MSG, METADATA, HOOKS )
  PP_TRYCALL(ERRFLAG_CALL_SEC4_ALLOC)  THIS%PRODUCT_DEFINITION_SECTION_%ALLOCATE( PAR, MSG, METADATA, HOOKS )
  PP_TRYCALL(ERRFLAG_CALL_SEC5_ALLOC)  THIS%DATA_REPRESENTATION_SECTION_%ALLOCATE( PAR, MSG, METADATA, HOOKS )
  PP_TRYCALL(ERRFLAG_CALL_SEC6_ALLOC)  THIS%BITMAP_SECTION_%ALLOCATE( PAR, MSG, METADATA, HOOKS )
...
PP_THREAD_SAFE FUNCTION GRIB2_ENCODER_PRESET( TTHIS, &
&  MSG, PAR, OPT,  METADATA, HOOKS ) RESULT(RET)
...
IMPLICIT NONE
  ...
  ! Allocate the sections
  PP_TRYCALL(ERRFLAG_CALL_SEC0_PRESET) THIS%INDICATOR_SECTION_%PRESET( PAR, MSG, METADATA, HOOKS )
  PP_TRYCALL(EERRFLAG_CALL_SEC1_PRESET) THIS%IDENTIFICATION_SECTION_%PRESET( PAR, MSG, METADATA, HOOKS )
  PP_TRYCALL(EERRFLAG_CALL_SEC2_PRESET) THIS%LOCAL_USE_SECTION_%PRESET( PAR, MSG, METADATA, HOOKS )
  PP_TRYCALL(ERRFLAG_CALL_SEC3_PRESET) THIS%GRID_DEFINITION_SECTION_%PRESET( PAR, MSG, METADATA, HOOKS )
  PP_TRYCALL(ERRFLAG_CALL_SEC4_PRESET) THIS%PRODUCT_DEFINITION_SECTION_%PRESET( PAR, MSG, METADATA, HOOKS )
  PP_TRYCALL(ERRFLAG_CALL_SEC5_PRESET) THIS%DATA_REPRESENTATION_SECTION_%PRESET( PAR, MSG, METADATA, HOOKS )
  PP_TRYCALL(ERRFLAG_CALL_SEC6_PRESET) THIS%BITMAP_SECTION_%PRESET( PAR, MSG, METADATA, HOOKS )
...
IMPLICIT NONE
  ...
  ! Allocate the sections
  PP_TRYCALL(ERRFLAG_CALL_SEC0_RUNTIME) THIS%INDICATOR_SECTION_%RUNTIME( PAR, MSG, CURR_TIME, TIME_HIST, METADATA, HOOKS )
  PP_TRYCALL(EERRFLAG_CALL_SEC1_RUNTIME) THIS%IDENTIFICATION_SECTION_%RUNTIME( PAR, MSG, CURR_TIME, TIME_HIST, METADATA, HOOKS )
  PP_TRYCALL(EERRFLAG_CALL_SEC2_RUNTIME) THIS%LOCAL_USE_SECTION_%RUNTIME( PAR, MSG, CURR_TIME, TIME_HIST, METADATA, HOOKS )
  PP_TRYCALL(ERRFLAG_CALL_SEC3_RUNTIME) THIS%GRID_DEFINITION_SECTION_%RUNTIME( PAR, MSG, CURR_TIME, TIME_HIST, METADATA, HOOKS )
  PP_TRYCALL(ERRFLAG_CALL_SEC4_RUNTIME) THIS%PRODUCT_DEFINITION_SECTION_%RUNTIME( PAR, MSG, CURR_TIME, TIME_HIST, METADATA, HOOKS )
  PP_TRYCALL(ERRFLAG_CALL_SEC5_RUNTIME) THIS%DATA_REPRESENTATION_SECTION_%RUNTIME( PAR, MSG, CURR_TIME, TIME_HIST, METADATA, HOOKS )
  PP_TRYCALL(ERRFLAG_CALL_SEC6_RUNTIME) THIS%BITMAP_SECTION_%RUNTIME( PAR, MSG, CURR_TIME, TIME_HIST, METADATA, HOOKS )
...
IMPLICIT NONE
  ...
  ! Allocate the sections
  PP_TRYCALL(ERRFLAG_CALL_SEC0_TO_BE_ENCODED) THIS%INDICATOR_SECTION_%TO_BE_ENCODED( PAR, MSG, CURR_TIME, TIME_HIST, LOC_TO_BE_ENCODED(1), HOOKS )
  PP_TRYCALL(EERRFLAG_CALL_SEC1_TO_BE_ENCODED) THIS%IDENTIFICATION_SECTION_%TO_BE_ENCODED( PAR, MSG, CURR_TIME, TIME_HIST, LOC_TO_BE_ENCODED(2), HOOKS )
  PP_TRYCALL(EERRFLAG_CALL_SEC2_TO_BE_ENCODED) THIS%LOCAL_USE_SECTION_%TO_BE_ENCODED( PAR, MSG, CURR_TIME, TIME_HIST, LOC_TO_BE_ENCODED(3), HOOKS )
  PP_TRYCALL(ERRFLAG_CALL_SEC3_TO_BE_ENCODED) THIS%GRID_DEFINITION_SECTION_%TO_BE_ENCODED( PAR, MSG, CURR_TIME, TIME_HIST, LOC_TO_BE_ENCODED(4), HOOKS )
  PP_TRYCALL(ERRFLAG_CALL_SEC4_TO_BE_ENCODED) THIS%PRODUCT_DEFINITION_SECTION_%TO_BE_ENCODED( PAR, MSG, CURR_TIME, TIME_HIST, LOC_TO_BE_ENCODED(5), HOOKS )
  PP_TRYCALL(ERRFLAG_CALL_SEC5_TO_BE_ENCODED) THIS%DATA_REPRESENTATION_SECTION_%TO_BE_ENCODED( PAR, MSG, CURR_TIME, TIME_HIST, LOC_TO_BE_ENCODED(6), HOOKS )
  PP_TRYCALL(ERRFLAG_CALL_SEC6_TO_BE_ENCODED) THIS%BITMAP_SECTION_%TO_BE_ENCODED( PAR, MSG, CURR_TIME, TIME_HIST, LOC_TO_BE_ENCODED(7), HOOKS )
...
IMPLICIT NONE
  ...
  INTEGER(KIND=JPIB_K), PARAMETER :: ERRFLAG_SEC5_ASSOCIATED=6_JPIB_K
  INTEGER(KIND=JPIB_K), PARAMETER :: ERRFLAG_SEC6_ASSOCIATED=7_JPIB_K
  INTEGER(KIND=JPIB_K), PARAMETER :: ERRFLAG_CALL_SEC0_PRINT=8_JPIB_K
  INTEGER(KIND=JPIB_K), PARAMETER :: EERRFLAG_CALL_SEC1_PRINT=9_JPIB_K
  INTEGER(KIND=JPIB_K), PARAMETER :: EERRFLAG_CALL_SEC2_PRINT=10_JPIB_K
  INTEGER(KIND=JPIB_K), PARAMETER :: ERRFLAG_CALL_SEC3_PRINT=11_JPIB_K
  INTEGER(KIND=JPIB_K), PARAMETER :: ERRFLAG_CALL_SEC4_PRINT=12_JPIB_K
  INTEGER(KIND=JPIB_K), PARAMETER :: ERRFLAG_CALL_SEC5_PRINT=13_JPIB_K
  INTEGER(KIND=JPIB_K), PARAMETER :: ERRFLAG_CALL_SEC6_PRINT=14_JPIB_K
  ...
  PP_TRYCALL(ERRFLAG_CALL_SEC0_PRINT) THIS%INDICATOR_SECTION_%PRINT( UNIT, OFFSET+2, HOOKS )
  PP_TRYCALL(EERRFLAG_CALL_SEC1_PRINT) THIS%IDENTIFICATION_SECTION_%PRINT( UNIT, OFFSET+2, HOOKS )
  PP_TRYCALL(EERRFLAG_CALL_SEC2_PRINT) THIS%LOCAL_USE_SECTION_%PRINT( UNIT, OFFSET+2, HOOKS )
  PP_TRYCALL(ERRFLAG_CALL_SEC3_PRINT) THIS%GRID_DEFINITION_SECTION_%PRINT( UNIT, OFFSET+2, HOOKS )
  PP_TRYCALL(ERRFLAG_CALL_SEC4_PRINT) THIS%PRODUCT_DEFINITION_SECTION_%PRINT( UNIT, OFFSET+2, HOOKS )
  PP_TRYCALL(ERRFLAG_CALL_SEC5_PRINT) THIS%DATA_REPRESENTATION_SECTION_%PRINT( UNIT, OFFSET+2, HOOKS )
  PP_TRYCALL(ERRFLAG_CALL_SEC6_PRINT) THIS%BITMAP_SECTION_%PRINT( UNIT, OFFSET+2, HOOKS )
  ! Trace end of procedure (on success)
  PP_TRACE_EXIT_PROCEDURE_ON_SUCCESS()
