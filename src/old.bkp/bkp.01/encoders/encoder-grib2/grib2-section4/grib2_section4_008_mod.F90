...
&               MSG, PAR, OPT, HOOKS ) RESULT(RET)
  ...
  USE :: HOOKS_MOD,                        ONLY: HOOKS_T
  USE :: GRIB2_SECTION4_TIME_FACTORY_MOD,  ONLY: MAKE_GRIB2_TIME_CONFIGURATOR
...
IMPLICIT NONE
  ...
  ! Trace begin of procedure
  PP_TRACE_ENTER_PROCEDURE()
  PP_METADATA_ENTER_PROCEDURE( METADATA, ERFLAG_METADATA )
  ...
  ! Enable section 4
  PP_METADATA_SET( METADATA, ERFLAG_METADATA, 'productDefinitionTemplateNumber', THIS%TEMPLATE_NUMBER_ )
  ...
  ! Trace end of procedure (on success)
  PP_METADATA_EXIT_PROCEDURE( METADATA, ERFLAG_METADATA )
  PP_TRACE_EXIT_PROCEDURE_ON_SUCCESS()
...
IMPLICIT NONE
  ...
  !> Local parameters
  CHARACTER(LEN=*), PARAMETER :: TIME_CONFIGURATOR_NAME='time-configurator'
