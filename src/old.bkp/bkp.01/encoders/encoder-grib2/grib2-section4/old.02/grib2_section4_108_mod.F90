...
CONTAINS
  ...
  !> GRIB2 encoder.
  !>
  PROCEDURE, PUBLIC, PASS, NON_OVERRIDABLE :: INIT_CFG => GRIB2_SECTION4_108_INIT_CFG
  ...
  !> the GRIB2 encoder.
  !>
  PROCEDURE, PUBLIC, PASS, NON_OVERRIDABLE :: INIT_LAZY => GRIB2_SECTION4_108_INIT_LAZY
...
IMPLICIT NONE
  ...
  ! Enable section 4
  PP_METADATA_SET( METADATA, 'productDefinitionTemplateNumber', 108_JPIB_K )
...
!>
!> @section interface
!>   @param [in]    THIS     An object of type `GRIB2_SECTION4_108_T` representing the GRIB section to be preset.
...
PP_THREAD_SAFE FUNCTION GRIB2_SECTION4_108_PRESET( THIS, &
&  MSG, PAR, OPT,  METADATA, HOOKS ) RESULT(RET)
...
!>
!> @section interface
!>   @param [in]    THIS      An object of type `GRIB2_SECTION4_108_T` representing the GRIB section for runtime execution.
!>   @param [in]    MSG       The message object of type `FORTRAN_MESSAGE_T` used to handle preset-related messaging.
!>   @param [in]    PAR       The parametrization structure of type `PARAMETRIZATION_T` used for the preset operation.
...
PP_THREAD_SAFE FUNCTION GRIB2_SECTION4_108_TO_BE_ENCODED( THIS, &
