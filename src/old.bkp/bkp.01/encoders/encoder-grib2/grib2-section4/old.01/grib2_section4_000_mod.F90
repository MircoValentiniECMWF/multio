...
CONTAINS
  ...
  !> the GRIB2 encoder.
  !>
  PROCEDURE, PUBLIC, PASS, NON_OVERRIDABLE :: INIT => GRIB2_SECTION4_000_INIT_LAZY
...
IMPLICIT NONE
  ...
  ! Create the time configuration object
  PP_TRYCALL(ERRFLAG_READ_TIME_CONFIGURATION) MAKE_TIME_CONFIGURATOR( THIS%TIME_CONFIGURATOR_, 'instant', OPT, HOOKS )

  ! Read the level configuration object
  PP_TRYCALL(ERRFLAG_READ_TIME_CONFIGURATION) MAKE_LEVEL_CONFIGURATOR( THIS%LEVEL_CONFIGURATOR_, CFG, OPT, HOOKS )

  ! Read the paramter configuration object
  PP_TRYCALL(ERRFLAG_READ_TIME_CONFIGURATION) MAKE_PARAM_CONFIGURATOR( THIS%PARAM_CONFIGURATOR_, 'param', OPT, HOOKS )
...
PP_THREAD_SAFE FUNCTION GRIB2_SECTION4_000_PRESET( HIS, &
&  MSG, PAR, OPT,  METADATA, HOOKS ) RESULT(RET)
...
PP_THREAD_SAFE FUNCTION GRIB2_SECTION4_000_TO_BE_ENCODED( HIS, &
