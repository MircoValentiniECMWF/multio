...
CONTAINS
  ...
  !> GRIB2 encoder.
  !>
  PROCEDURE, PUBLIC, PASS, NON_OVERRIDABLE :: INIT => GRIB2_SECTION4_041_INIT_CFG
  ...
  !> the GRIB2 encoder.
  !>
  PROCEDURE, PUBLIC, PASS, NON_OVERRIDABLE :: INIT => GRIB2_SECTION4_041_INIT_LAZY
...
!>
!> @section interface
!>   @param [inout] THIS  An object of type `GRIB2_SECTION4_041_T` representing the GRIB section being initialized.
...
#define PP_PROCEDURE_NAME 'GRIB2_SECTION4_041_INIT_CFG'
PP_THREAD_SAFE FUNCTION GRIB2_SECTION4_041_INIT_CFG( THIS, &
...
END FUNCTION GRIB2_SECTION4_041_INIT_CFG
...
!>
#define PP_PROCEDURE_TYPE 'FUNCTION'
#define PP_PROCEDURE_NAME 'GRIB2_SECTION4_041_INIT_LAZY'
PP_THREAD_SAFE FUNCTION GRIB2_SECTION4_041_INIT_LAZY( THIS, &
...
END FUNCTION GRIB2_SECTION4_041_INIT_LAZY
#undef PP_PROCEDURE_NAME
#undef PP_PROCEDURE_TYPE
...
!>
!> @section interface
!>   @param [in]    THIS     An object of type `GRIB2_SECTION4_041_T` representing the GRIB section to allocate resources for.
!>   @param [in]    MSG      All the mars keywords needed to describe the field `FORTRAN_MESSAGE_T`.
!>   @param [in]    PAR      All information outside mars keywords needed to describe the field `PARAMETRIZATION_T`.
!>   @param [in]    OPT      The encoder options structure of type `ENCODER_OPTIONS_T`.
...
PP_THREAD_SAFE FUNCTION GRIB2_SECTION4_041_ALLOCATE( THIS, &
...
PP_THREAD_SAFE FUNCTION GRIB2_SECTION4_041_PRESET( HIS, &
&  MSG, PAR, OPT,  METADATA, HOOKS ) RESULT(RET)
...
PP_THREAD_SAFE FUNCTION GRIB2_SECTION4_041_RUNTIME( THIS, &
...
!>
!> @section interface
!>   @param [inout] THIS          An object of type `GRIB2_SECTION4_041_T` representing the GRIB section being checked.
!>   @param [in]    MSG           The message object of type `FORTRAN_MESSAGE_T` used to handle preset-related messaging.
!>   @param [in]    PAR           The parametrization structure of type `PARAMETRIZATION_T` used for the preset operation.
!>   @param [in]    TIME_HIST     The time history object of type `TIME_HISTORY_T` providing historical time data.
...
PP_THREAD_SAFE FUNCTION GRIB2_SECTION4_041_TO_BE_ENCODED( HIS, &
...
!>
!> @section interface
!>   @param [inout] THIS  An object of type `GRIB2_SECTION4_041_T` representing the GRIB section to be freed.
!>   @param [in]    OPT   The encoder options structure of type `ENCODER_OPTIONS_T`.
...
PP_THREAD_SAFE FUNCTION GRIB2_SECTION4_041_FREE( THIS, OPT, HOOKS ) RESULT(RET)
...
PP_THREAD_SAFE FUNCTION GRIB2_SECTION4_041_PRINT( THIS, &
