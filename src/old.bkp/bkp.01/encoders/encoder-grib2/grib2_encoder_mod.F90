...
IMPLICIT NONE
  ...
  PP_TRYCALL(ERRFLAG_CALL_SEC6_ALLOC)  THIS%BITMAP_SECTION_%ALLOCATE             ( MSG, PAR, OPT, METADATA, HOOKS )
...
IMPLICIT NONE
  ...
  PP_TRYCALL(ERRFLAG_CALL_SEC6_PRESET) THIS%BITMAP_SECTION_%PRESET             ( MSG, PAR, OPT, METADATA, HOOKS )
